				...
				<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) !== 'yes' ) : ?>
					<div class="row">
						<div class="col-sm-6">
							...
							<p><?php _e( 'Ao criar uma conta na Lava e Traz, você será capaz de realizar pedidos Online nas melhores lavanderias da sua cidade, visualizar e acompanhar seus pedidos na sua conta e muito mais.', 'porto'); ?></p>
							<a class="btn btn-primary" href="<?php echo get_permalink( woocommerce_get_page_id( 'myaccount' ) ) . '?action=register'?>"><?php _e( 'Criar Conta', 'porto' ); ?></a>
						</div>
						<div class="col-sm-6">
				<?php endif; ?>
							...
							<form method="post" class="login" id="formlogin">
								...
								<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
									...
									<input Required placeholder="<?php _e( 'Username or email address', 'porto' ); ?>" type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
								</p>
								<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
									...
									<input Required placeholder="<?php _e( 'Password', 'porto' ); ?>"  class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="password" id="password" />
								</p>
								...
								<p class="form-row clearfix">
									...
									<input type="submit" class="woocommerce-Button button btn-lg pt-right" name="login" value="<?php esc_attr_e( 'Entrar', 'porto' ); ?>" />
								</p>
