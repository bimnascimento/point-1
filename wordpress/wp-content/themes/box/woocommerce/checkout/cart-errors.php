...
<div class="erro-cart">
		...
		<div class="erro-cart-div">

					<div class="erro-cart-div-icon"></div>
					...
					<p><a class="button wc-backward click-loading" href="<?php echo esc_url( wc_get_page_permalink( 'cart' ) ); ?>"><?php _e( 'Return to cart', 'woocommerce' ) ?></a></p>
