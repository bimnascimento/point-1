...
if( !function_exists( "cp_ib_global_before_init" ) ) {
	function cp_ib_global_before_init( $a ) {
		...
		$toggle_btn_font_size 		= $a['toggle_btn_font_size'];
		$toggle_btn_border_radius 	= $a['toggle_btn_border_radius'];
		$toggle_btn_border_size 	= $a['toggle_btn_border_size'];
		$toggle_button_border_color = $a['toggle_button_border_color'];
		$toggle_btn_padding_lrv 	= $a['toggle_btn_padding_lrv'];
		$toggle_btn_padding_tb 		= $a['toggle_btn_padding_tb'];
