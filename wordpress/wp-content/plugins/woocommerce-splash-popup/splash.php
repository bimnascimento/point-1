...
Plugin URI: http://www.woothemes.com/products/woocommerce-splash-popup/
...
function wc_splash_popup_plugin_links( $links ) {
	...
	$plugin_links = array(
		'<a href="http://support.woothemes.com/">' . __( 'Support', 'wc_splash' ) . '</a>',
		'<a href="http://docs.woothemes.com/document/woocommerce-splash-popup">' . __( 'Docs', 'wc_splash' ) . '</a>',
	);
		...
		class WC_Splash {
			...
			public function __construct() {
	            ...
	            $this->settings_tabs = array(
	                'wc_splash' => __( 'Splash Popup', 'wc_splash' )
	            );
