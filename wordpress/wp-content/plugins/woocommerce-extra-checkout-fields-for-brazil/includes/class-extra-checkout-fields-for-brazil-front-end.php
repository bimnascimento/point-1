...
class Extra_Checkout_Fields_For_Brazil_Front_End {
	...
	public function checkout_billing_fields( $fields ) {
		...
		if ( isset( $fields['billing_first_name'] ) ) {
			...
			$new_fields['billing_first_name']['class'] = array( 'form-row-first','hidden' );
		}

		if ( isset( $fields['billing_last_name'] ) ) {
			$new_fields['billing_last_name'] = $fields['billing_last_name'];
			$new_fields['billing_last_name']['class'] = array( 'form-row-last','hidden' );
		}
		//*/
		if ( 0 !== $person_type ) {
			if ( 1 === $person_type ) {
			...
			if ( 1 === $person_type || 3 === $person_type ) {
				if ( isset( $fields['billing_company'] ) ) {
					...
					$new_fields['billing_company']['placeholder'] =  __( 'Razão Social', 'woocommerce-extra-checkout-fields-for-brazil' );
				}
		...
		if ( isset( $fields['billing_country'] ) ) {
			...
			$new_fields['billing_country']['class'] = array( 'form-row-wide', 'address-field', 'update_totals_on_change','hidden' );
		}
		//*/
		if ( isset( $fields['billing_postcode'] ) ) {
			...
			$new_fields['billing_postcode']['placeholder'] =  __( 'CEP', 'woocommerce-extra-checkout-fields-for-brazil' );
		}
		...
		if ( isset( $fields['billing_city'] ) ) {
			...
			$new_fields['billing_city']['placeholder'] =  __( 'Cidade', 'woocommerce-extra-checkout-fields-for-brazil' );
		}
		///*
		if ( isset( $fields['billing_state'] ) ) {
			$new_fields['billing_state'] = $fields['billing_state'];
			$new_fields['billing_state']['class'] = array( 'form-row-wide', 'address-field','hidden' );
		...
		if ( isset( $settings['cell_phone'] ) ) {
			...
			if ( isset( $fields['billing_phone'] ) ) {
				...
				$new_fields['billing_phone']['placeholder'] =  __( 'Phone', 'woocommerce-extra-checkout-fields-for-brazil' );
			}
	...
	public function checkout_shipping_fields( $fields ) {
		...
		if ( isset( $fields['shipping_first_name'] ) ) {
			...
			$new_fields['shipping_first_name']['class'] = array( 'form-row-first','hidden' );
		}

		if ( isset( $fields['shipping_last_name'] ) ) {
			$new_fields['shipping_last_name'] = $fields['shipping_last_name'];
			$new_fields['shipping_last_name']['class'] = array( 'form-row-last','hidden' );
		}

		if ( isset( $fields['shipping_company'] ) ) {
			$new_fields['shipping_company'] = $fields['shipping_company'];
			$new_fields['shipping_company']['class'] = array( 'form-row-wide','hidden' );
		...
		if ( isset( $fields['shipping_country'] ) ) {
			...
			$new_fields['shipping_country']['class'] = array( 'form-row-wide', 'address-field', 'update_totals_on_change','hidden' );
		}
		//*/
		if ( isset( $fields['shipping_postcode'] ) ) {
			...
			$new_fields['shipping_postcode']['placeholder'] =  __( 'CEP', 'woocommerce-extra-checkout-fields-for-brazil' );
		}
		...
		if ( isset( $fields['shipping_city'] ) ) {
			...
			$new_fields['shipping_city']['placeholder'] =  __( 'Cidade', 'woocommerce-extra-checkout-fields-for-brazil' );
		}
		///*
		if ( isset( $fields['shipping_state'] ) ) {
			$new_fields['shipping_state'] = $fields['shipping_state'];
			$new_fields['shipping_state']['class'] = array( 'form-row-wide', 'address-field','hidden' );
	...
	public function formatted_address_replacements( $replacements, $args ) {
		//dump( !empty($args['number']) );
		if(!empty($args['number'])) $replacements['{number}']       = $args['number'];
		if(!empty($args['neighborhood'])) $replacements['{neighborhood}'] = $args['neighborhood'];
