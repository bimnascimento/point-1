<?php
    ...
    /**
     * Class ReduxSAFramework_password
     */
...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'ReduxSAFramework_password' ) ) {
        class ReduxSAFramework_password {
            ...
            private function _render_combined_field() {
                ...
                $defaults = array(
                    ...
                    'password'    => '',
                    'placeholder' => array(
                        'password' => __( 'Password', 'reduxsa-framework' ),
                        'username' => __( 'Username', 'reduxsa-framework' )
                    )
                );
