...
// Don't duplicate me!
if ( !class_exists ( 'ReduxSAFramework_checkbox' ) ) {

    /**
     * Main ReduxSAFramework_checkbox class
     *
     * @since       1.0.0
     */
    class ReduxSAFramework_checkbox {
        ...
        public function enqueue () {
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style (
                    'reduxsa-field-checkbox-css',
                    ReduxSAFramework::$_url . 'inc/fields/checkbox/field_checkbox.css',
                    array(),
                    time (),
                    'all'
                );
            ...
            wp_enqueue_script (
                'reduxsa-field-checkbox-js',
                ReduxSAFramework::$_url . 'inc/fields/checkbox/field_checkbox' . ReduxSA_Functions::isMin () . '.js',
