...
class Dokan_Product_Enquiry {
    ...
    function show_form() {
        ...
        <h3 style="margin-bottom: 25px;"><?php _e( 'Product Enquiry', 'dpe' ); ?></h3>
            ...
            <div class="col-md-10">
                <form id="dokan-product-enquiry" method="post" class="form" role="form">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="dokan-enq-message" name="enq_message" placeholder="<?php _e( 'Details about your enquiry...', 'dpe' ); ?>" rows="5" required></textarea>
                    </div>
                    ...
                    <input class="btn btn-theme" type="submit" value="<?php _e( 'Submit Enquiry', 'dpe' ); ?>">
                </form>
            </div>
        </div>
        <?php
