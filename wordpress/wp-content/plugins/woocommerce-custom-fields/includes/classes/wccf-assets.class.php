...
class WCCF_Assets
{
    ...
    public static function enqueue_frontend_stylesheets()
    {
        ...
        // Frontend styles
        self::enqueue_or_inject_stylesheet('wccf-frontend-styles', WCCF_PLUGIN_URL . '/assets/css/frontend.css', WCCF_VERSION);
    }
    ...
    {
        // Field styling
        self::enqueue_or_inject_stylesheet('wccf-field-styles', WCCF_PLUGIN_URL . '/assets/css/fields.css', WCCF_VERSION);
    }
    ...
    public static function enqueue_datepicker_stylesheets()
    {
        ...
        self::enqueue_or_inject_stylesheet('wccf-jquery-ui-styles', WCCF_PLUGIN_URL . '/assets/jquery-ui/jquery-ui.min.css', '1.11.4');
    }
