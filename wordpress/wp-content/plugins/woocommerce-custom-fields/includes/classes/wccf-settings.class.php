                        ...
                        'addon_pricing' => array(
                            ...
                            'children' => array(
                                'product_field_prices_include_default' => array(
                                    'title'     => __('Product prices adjusted to default values', 'rp_wccf'),
                                    'type'      => 'checkbox',
                                    'default'   => '1',
                                ),
                        ...
                        'frontend_display' => array(
                            ...
                            'children' => array(
                                'display_default_product_prop_values' => array(
                                    'title'     => __('Default values displayed automatically', 'rp_wccf'),
                                    'type'      => 'checkbox',
                                    'default'   => '0',
            ...
            foreach ($tab['children'] as $section_key => $section) {
                foreach ($section['children'] as $field_key => $field) {
                    ...
                    if (isset($stored[$field_key])) {
                        $instance->settings[$field_key] = $stored[$field_key];
                    }
                    else {
                        $instance->settings[$field_key] = isset($field['default']) ? $field['default'] : null;
                    }
