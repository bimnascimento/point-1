...
$rows = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE del='1'" );
...
<div id="yith-woocommerce-customer-history">
    <div id="sessions" class="wrap">
        ...
        <h1><?php echo __( 'Trash', 'yith-woocommerce-customer-history' ); ?></h1>
        ...
        <div class="tablenav top">
            <ul class="subsubsub" style="margin-top: 4px; display: inline-block; float: none;">
                <li class="sessions"><a href="admin.php?page=yith-wcch-sessions.php"><?php echo __( 'Sessions', 'yith-woocommerce-customer-history' ); ?></a> |</li>
                <li class="trash"><a href="admin.php?page=yith-wcch-trash.php" class="current"><?php echo __( 'Trash', 'yith-woocommerce-customer-history' ); ?></a></li>
            </ul>
        ...
        <table class="wp-list-table widefat fixed striped posts">
            ...
            $query = "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE del='1' ORDER BY reg_date DESC LIMIT $sessions_offset,$results_per_page";
