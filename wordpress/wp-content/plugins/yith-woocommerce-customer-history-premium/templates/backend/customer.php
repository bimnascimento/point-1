    ...
    if ( $user_id > 0 && current_user_can( 'manage_options' ) ) :
        ...
        <div id="customer" class="wrap">
            ...
            $customer_orders = get_posts( array(
                ...
                'meta_value'  => $user_id,
                'post_type'   => 'shop_order',
                'post_status' =>  array( 'pending', 'processing', 'on-hold', 'completed', 'cancelled', 'refunded', 'failed', 'pagamento-ok', 'saiu-para-entrega', 'saiu-para-coleta', 'lavando-pecas',
                                         'wc-pending', 'wc-processing', 'wc-on-hold', 'wc-completed', 'wc-cancelled', 'wc-refunded', 'wc-failed', 'wc-pagamento-ok', 'wc-saiu-para-entrega', 'wc-saiu-para-coleta', 'wc-lavando-pecas' ),
            ) );
