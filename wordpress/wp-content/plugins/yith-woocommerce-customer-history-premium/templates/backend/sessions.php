...
$rows = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE del='0'" );
$num_rows = $wpdb->num_rows;
$max_pages = ceil( $num_rows / $results_per_page );

$trash_rows = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE del='1'" );
    ...
    <div id="sessions" class="wrap">
        ...
        <div class="tablenav top">
            ...
            <ul class="subsubsub" style="margin: 1px 0px 0px 10px; display: inline-block; float: none;">
                <li class="sessions"><a href="admin.php?page=yith-wcch-sessions.php" class="current"><?php echo __( 'Sessions', 'yith-woocommerce-customer-history' ); ?></a> |</li>
                <li class="trash"><a href="admin.php?page=yith-wcch-trash.php" style="padding-right: 0;"><?php echo __( 'Trash', 'yith-woocommerce-customer-history' ); ?></a> (<?php echo $trash_num_rows; ?>)</li>
            </ul>
        ...
        <table class="wp-list-table widefat fixed striped posts">
            ...
            $query = "SELECT * FROM {$wpdb->prefix}yith_wcch_sessions WHERE del='0' ORDER BY reg_date DESC LIMIT $sessions_offset,$results_per_page";
        ...
        <style>
            ...
            #sessions table tr.bot { background-color: #ddf; }
