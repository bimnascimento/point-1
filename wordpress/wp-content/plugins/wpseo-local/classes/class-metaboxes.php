            ...
            <div id="wpseo_add_map" style="display:none;">
                <div class="wrap">
                    <div>
						...
						<?php } ?>
						<?php if ( wpseo_has_multiple_locations() && empty( $locations ) ) { ?>
                            <p>In order to use this shortcode function, please <a href="<?php echo trailingslashit( admin_url() ) . 'edit.php?post_type=wpseo_loctions'; ?>">add one or more locations</a> first.</p>
						<?php } ?>
                    </div>
                </div>
            </div>
