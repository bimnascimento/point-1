<?php
	...
	class hmapsprem_setup{
		...
		public function __construct($plugin_name,$plugin_dir,$plugin_url,$plugin_friendly_name,$plugin_version,$plugin_prefix,$first_release,$last_update,$plugin_friendly_description){	
			...
			$shortcode = new hmapsprem_shortcodes($this->plugin_prefix,$this->plugin_name,$this->plugin_dir,$this->plugin_url);
		...
		public function add_admin_meta(){
			//load global helper
			global $hmapsprem_helper;
			if(is_admin() && $hmapsprem_helper->onAdmin()){ //admin panel
		...
		public function load_admin_javascript(){
			...
			if(is_admin() && $hmapsprem_helper->onAdmin()){ //admin panel
				...
				wp_register_script($this->plugin_prefix .'hmapsprem_object_manager', $this->plugin_url .'assets/js/hmapsprem_object_manager.js');
				wp_enqueue_script($this->plugin_prefix .'hmapsprem_object_manager');
				//marker processor
				...
				//map_importer
				wp_register_script($this->plugin_prefix .'map_importer', $this->plugin_url .'assets/js/map_import_processor.js');
				wp_enqueue_script($this->plugin_prefix .'map_importer');
