...
(function( $ ) {
   ...
   $( function() {
        ...
        //console.log("pagseguro transparent mim");
		...
		function pagSeguroAddErrorMessage( error ) {
			...
			wrapper.prepend( '<script>jQuery(".loading-site").hide();</script><div class="woocommerce-error" style="margin-bottom: 0.5em !important;">' + error + '</div>' );
		}
		...
		function pagSeguroformHandler() {
			...
			var form = $( 'form.checkout, form#order_review' ),
				...
				error           = false,
				errorHtml       = '<script>jQuery(".loading-site").hide();</script>',
