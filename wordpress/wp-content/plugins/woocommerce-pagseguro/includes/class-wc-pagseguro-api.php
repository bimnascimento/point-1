	...
	protected function get_payment_xml( $order, $posted ) {
		...
		if ( 'creditCard' == $method ) {
			...
			$holder_data       = array(
                ...
                'number'      => isset( $posted['pagseguro_card_holder_number'] ) ? sanitize_text_field( $posted['pagseguro_card_holder_number'] ) : '',
                'expiry'      => isset( $posted['pagseguro_card_holder_expiry'] ) ? sanitize_text_field( $posted['pagseguro_card_holder_expiry'] ) : '',
                'cvc'      => isset( $posted['pagseguro_card_holder_cvc'] ) ? sanitize_text_field( $posted['pagseguro_card_holder_cvc'] ) : '',
                'installments'      => isset( $posted['pagseguro_card_installments'] ) ? sanitize_text_field( $posted['pagseguro_card_installments'] ) : '',
			);
