...
class WC_PagSeguro_XML extends SimpleXMLElement {
	...
	public function add_receiver_email( $receiver_email ) {
        ...
        //$receiver->addChild( 'email', "teste@teste.com.br" );
	}
	...
	public function add_sender_data( $order, $hash = '' ) {
        ...
        //$email = explode("@",$order->billing_email);
        //$sender->addChild( 'email' )->add_cdata( $email[0]."@lavaetraz.com.br" );

        //$sender->addChild( 'email' )->add_cdata( "boxclickjf@gmail.com" );
