...
(function($) {
    $.fn.wondercarousellightbox = function(options) {
        ...
        inst.calcBoxPosition = function(initW, initH) {
            ...
            var topmargin = $(window).width() < inst.options.navarrowsbottomscreenwidth ?
        ...
        inst.showNavigation = function() {
            ...
            $("body").append("<div class='html5-nav' style='display:block;position:fixed;" + posCss + "width:100%;height:" + inst.options.navheight + "px;z-index:9999999;" + (inst.options.navbgcolor ? "background-color:" + inst.options.navbgcolor +
                ...
                "</div>" + "<div class='html5-nav-next' style='display:block;position:absolute;cursor:pointer;width:" + inst.options.navbuttonwidth + 'px;height:100%;right:0;top:0;background:url("' + inst.options.navarrowsnextimage + "\") no-repeat right center;'></div>" + "</div>" + "</div>");
