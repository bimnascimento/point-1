        ...
        function print_html_in_page_header()
        {
            if(!Filetrip_Dropbox_Utility::check_if_dropbox_disabled() && !Filetrip_Dropbox::is_dropbox_active())
            {
                ...
                <div class="error settings-error notice is-dismissible"> 
                    ...
                    <br><a target="_blank" href='<?php echo admin_url(Filetrip_Uploader::$plugin_option_page).'&action=do_dropbox_auth&arfaly_nonce='.  wp_create_nonce(Filetrip_Constants::NONCE); ?>' class="button button-large" >Authorize your plugin</a>
                </div>
                <?php
            }
