    ...
    class Filetrip_Google_Drive_Setting_page
    {
        ...
        function print_html_in_page_header()
        {
            ...
            if(!Filetrip_Drive_Utility::check_if_drive_disabled() && $drive_auth_state)
            {
                ...
                <br><a target="_blank" href='<?php echo admin_url(Filetrip_Uploader::$plugin_option_page).'&action=do_drive_auth&arfaly_nonce='.  wp_create_nonce(Filetrip_Constants::NONCE); ?>' class="button button-large" style="margin-bottom:10px;margin-left:10px" >Authorize your plugin</a>
                </div>
                <?php
            }
        }
