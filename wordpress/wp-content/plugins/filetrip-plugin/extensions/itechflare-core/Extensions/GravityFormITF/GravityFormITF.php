...
class GravityFormITF extends FlareExtension
{
	...
	function load_filetrip_scripts($form, $is_ajax) {
		...
		wp_enqueue_script(
				...
				ITECHFILETRIPPLUGINURL.'/assets/js/filetrip-multi-min.js', array('jquery'), \Filetrip_Constants::VERSION, true
			);
	}
	...
	function load_filetrip_styles($styles, $form) {
		wp_register_style( 'filetrip-default',
				ITECHFILETRIPPLUGINURL.'/assets/css/style.css', array(), \Filetrip_Constants::VERSION);
