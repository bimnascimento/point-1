  ...
  */
  ...
  public function build_json_titles()
  {
    $titles = '[
            ...
            { title: \'<a class="arfaly-header-check-label" href="javascript:check_all()"><span class="icon-check"></span></a><br><a class="arfaly-header-check-label" href="javascript:clear_all()"><span class="icon-check-empty"></span></a>\' },
        ]';
