<?php
namespace iTechFlare\WP\Plugin\Core;

use iTechFlare\WP\Plugin\iTechFlareCore;
use iTechFlare\WP\Plugin\Core\Filetrip;
...
final class AdminMenu
{
	 ...
	 * @var array
	 */
	protected $core_extension = \Filetrip_Constants::ACTIVATE_BY_DEFAULT;
	...
	private function initExtensions()
	{
		...
		$loaded = true;
		$this->extensionInitializer = $this
			->extensionLoader
