<?php
/**
 * @internal iTechFlare\WP\Plugin\Core\AdminMenu
 */
if (!isset($this) || ! class_exists('\\iTechFlare\\WP\\Plugin\\Core\\AdminMenu')
	|| ! $this instanceof iTechFlare\WP\Plugin\Core\AdminMenu
) {
	return;
}

/**
 * @var \iTechFlare\WP\Plugin\Core\ExtensionLoader
 */
		...
		<div class="wp-list-table widefat itf_wp-module-install">
			...
			<div id="itf_wp-module-list">
				...
				foreach ((array) $this->getAllAvailableExtensions() as $extensionName) {
					...
					/**
					 * @var \iTechFlare\WP\Plugin\Core\Abstracts\FlareExtension
					 */
					...
					// classes
					$class = in_array($extensionName, $core_extension) ? 'core-extension' : '';
