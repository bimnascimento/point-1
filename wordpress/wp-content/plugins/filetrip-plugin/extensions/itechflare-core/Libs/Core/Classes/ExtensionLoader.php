...
use iTechFlare\WP\Plugin\Core\Helper\ReflectorHelper;
...
final class ExtensionLoader
{
	 ...
	 * @var array
	 */
	private static $status_extension = array();
	...
	public function injectExtensionTo($name, $extension_class)
	{
		if (is_string($extension_class) && class_exists($extension_class)
			...
			&& is_subclass_of($extension_class, '\\iTechFlare\\WP\\Plugin\\Core\\Abstracts\\FlareExtension')
		) {
