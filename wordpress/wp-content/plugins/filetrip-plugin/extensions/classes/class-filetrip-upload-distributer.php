...
class Filetrip_Distributor
{
  ...
  */
  function custom_filetrip_bulk_action() {
    ...
    if ( !isset( $_REQUEST['detached'] ) ) {
      ...
      $redirect_args = array(
        'channel' => $action, 
        'source' => Filetrip_Constants::TRANSFER_REQUEST_SOURCE['media']
        );
  ...
  function distributer_admin_enqueue()
  {
    ...
    {
      wp_enqueue_style( 'filetrip_distributor_style', ITECHFILETRIPPLUGINURL . '/assets/css/distributor-admin.css' );

      // Register the script first.
      wp_enqueue_script( 'filetrip_event_source_js', ITECHFILETRIPPLUGINURL . '/assets/js/event-source.js', array('jquery'), Filetrip_Constants::VERSION, true );
      wp_enqueue_script( 'filetrip_backend_uploader_js', ITECHFILETRIPPLUGINURL . '/assets/js/filetrip-backend-uploader.js', array('jquery', 'filetrip_event_source_js'), Filetrip_Constants::VERSION, true );
      wp_register_script( 'filetrip_distributor_js', ITECHFILETRIPPLUGINURL . '/assets/js/filetrip-distributor.js' );
      ...
      switch($_GET['source']){
        case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['media']: case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['forward']:
        ...
        case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['backup']:
          ...
          $translation_array['source'] = Filetrip_Constants::TRANSFER_REQUEST_SOURCE['backup'];
  ...
  {
    include_once ITECHFILETRIPPLGUINURI . "/extensions/classes/templates/filetrip-transfer-card.php";
  }
  ...
  */
  function arfaly_render_files_distributor()
  {
      ...
      However, you suuposed to be able to close the window and walk away instead of waiting, and the process should be maintained.</div>
      <br><br>
      <div>
        ...
        <div class="filetrip-distribution-navigation--menu">
          ...
          <?php if($_GET['source']==Filetrip_Constants::TRANSFER_REQUEST_SOURCE['forward']) { ?>
  ...
  */
  function extract_upload_file_information($att_id, $source)
  {
    ...
    */ 
    ...
    switch($source){
      case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['media']:
        
        $json_data['source'] = Filetrip_Constants::TRANSFER_REQUEST_SOURCE['media'];
      ...
      case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['backup']:
        ...
        $json_data['source'] = Filetrip_Constants::TRANSFER_REQUEST_SOURCE['backup'];

        break;

      case Filetrip_Constants::TRANSFER_REQUEST_SOURCE['forward']:

        $json_data['source'] = Filetrip_Constants::TRANSFER_REQUEST_SOURCE['forward'];
        // Apply filter to retrieve active channels 
