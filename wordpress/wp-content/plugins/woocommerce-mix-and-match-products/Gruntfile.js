  ...
  grunt.initConfig({
	...
	addtextdomain: {
		options: {
            ...
            updateDomains: [ 'woocommerce-mix-and-match', 'woocommerce-mix-and-match-min-max-quantities', 'woocommerce' ]  // List of text domains to replace.
        },
		target: {
			files: {
...
grunt.registerTask( 'dev', [ 'replace', 'newer:sass', 'newer:uglify', 'makepot' ] );
