...
class WC_Dokan_Paypal_Ap_Gateway extends WC_Payment_Gateway {
    ...
    public function admin_options() {
        ...
        <p><?php _e( 'PayPal Adaptive works by sending payment to multiple user email', 'dokan-wc-pap' ); ?></p>
    ...
    function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'fees_payer' => array(
                'title'       => __( 'Fees Payer', 'dokan-wc-pap' ),
                'type'        => 'select',
                'description' => __( 'Please choose who will pay the fee', 'dokan-wc-pap' ),
                'desc_tip'    => true,
                'default'     => 'each',
                'options'     => array(
                    'each'  => __( 'Each receiver', 'dokan-wc-pap' ),
                    'admin' => __( 'Admin', 'dokan-wc-pap' ),
                    'seller' => __( 'Seller', 'dokan-wc-pap' )
                )
            ),
            'send_shipping' => array(
            ...
            'appuser' => array(
                'title'       => __( 'API Username', 'dokan-wc-pap' ),
                'type'        => 'text',
            ...
            'apppass' => array(
                'title'       => __( 'API Password', 'dokan-wc-pap' ),
                'type'        => 'text',
                'description' => __( 'For this payment method your need an application credential', 'dokan-wc-pap' ),
                'default'     => '',
                'desc_tip'    => true,
            ...
            'appsig' => array(
                'title'       => __( 'API Signature', 'dokan-wc-pap' ),
                'type'        => 'text',
                'description' => __( 'For this payment method your need an application credential', 'dokan-wc-pap' ),
                'default'     => '',
                'desc_tip'    => true,
