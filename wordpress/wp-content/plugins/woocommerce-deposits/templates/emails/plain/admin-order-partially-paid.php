...
echo sprintf( __( 'You have received a partially-paid order from %s. Their order is as follows:', 'woocommerce-deposits' ), $order->billing_first_name . ' ' . $order->billing_last_name ) . "\n\n";
