...
class DPS_Manager {
    ...
    public static function get_subscription_period_strings( $number = 1, $period = '' ) {
        ...
        $translated_periods = array(
            'day'   => sprintf( _n( 'day(s)', '%s days', $number, 'dps' ), $number ),
            'week'  => sprintf( _n( 'week(s)', '%s weeks', $number, 'dps' ), $number ),
            'month' => sprintf( _n( 'month(s)', '%s months', $number, 'dps' ), $number ),
            'year'  => sprintf( _n( 'year(s)', '%s years', $number, 'dps' ), $number )
        );
    ...
    public static function get_subscription_ranges( $subscription_period = '' ) {
        ...
        $subscription_ranges[''] = __( 'Never', 'dps' );
