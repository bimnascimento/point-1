...
class DPS_Pack_On_Registration {
    ...
    function generate_form_fields() {
        ...
        ?>
        <label for="dokan-subscription-pack"><?php _e( 'Choose Subscription Pack', 'dps' ) ?><span class="required"> *</span></label>
                ...
                <div class="dps-pack dps-pack-<?php echo get_the_ID() ?>">
                    ...
                    <div class="pack_content">
                        ...
                        <?php if ( $is_recurring && $recurring_interval > 1 ) { ?>
                            <span class="dps-rec-period">
                                <i>
                                    <?php printf( __( 'In every %d %s(s)', 'dps' ), $recurring_interval, $recurring_period ); ?>
                                </i>
                            </span>
                        <?php } ?>
                    </div>
