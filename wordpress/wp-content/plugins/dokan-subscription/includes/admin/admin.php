    ...
    function add_new_setting_field_admin_panael( $settings_fields ) {
        ...
        $settings_fields['dokan_product_subscription'] = array(
            ...
            array(
                ...
                'desc'  => __( 'Enable Subscription pack in registration form for new seller', 'dps' ),
                'type'  => 'checkbox',
                'default' => 'on'
            ),
            ...
            array(
                ...
                'desc'    => __( 'Before an email will be sent to the seller', 'dps' ),
                'type'    => 'text',
                'size'    => 'midium',
                'default' => '2'
            ),
            array(
                ...
                'desc'    => __( 'Product status when seller pack validity will expire', 'dps' ),
                'type'    => 'select',
                'default' => 'draft',
                'options' => array(
