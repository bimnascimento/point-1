...
if (!class_exists('rp_shipping_calculator')) {
    ...
    class rp_shipping_calculator {
        ...
        public function __construct()
        {
            ...
            if ($this->get_setting("enable_on_productpage") == 1) {
                ...
                elseif ($this->get_setting("button_pos") == 2)
                    add_action('woocommerce_after_single_product_summary', array(&$this, 'display_shipping_calculator'), 10);
                else
                    add_action('woocommerce_single_product_summary', array(&$this, 'display_shipping_calculator'), 8);
                //*/
                //add_action('woocommerce_single_product_summary', array($this, 'display_cadastro'), 100);
            }
        ...
        public function display_cadastro()
        {
            ob_start();
                echo '<div class="rp_shipping_button"> display_cadastro <a href="javascript:void(0);" class="btn_shipping">Quero me cadastrar!</a></div>';
