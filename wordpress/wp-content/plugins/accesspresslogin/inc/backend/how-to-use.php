...
<dl>
  ...
  <dd><p>You can use shortcode for the display of the social logins in the contents of a posts and pages.
    <ul class="how-list">
      <li>Example 1: [apsl-login theme='2' login_text='Social Connect']</li>
      ...
      <li>Example 2: [apsl-login-with-login-form template='3' theme='1' login_text='Please login to site']</li>
      <li>Shortcode attributes: <br />
