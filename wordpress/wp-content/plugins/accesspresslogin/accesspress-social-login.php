...
if( !class_exists( 'APSL_Class' ) ) {
    ...
    class APSL_Class
    {
        ...
        function add_apsl_menu() {
            add_menu_page( 'AccessPress', 'AccessPress', 'manage_options', APSL_TEXT_DOMAIN, array($this, 'main_page'), APSL_IMAGE_DIR . '/icon.png' );
        }
