...
class WCS_Admin_Post_Types {
	...
	public function post_updated_messages( $messages ) {
		...
		$messages['shop_subscription'] = array(
			...
			9 => 'Subscription scheduled for: <strong>' . date_i18n( _x( 'M j, Y @ G:i', 'used in "Subscription scheduled for <date>"', 'woocommerce-subscriptions' ), wcs_date_to_time( $post->post_date ) ) . '</strong> .',
