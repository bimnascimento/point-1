...
jQuery(document).ready( function($) {
	...
	function lwaAjax( data, statusElement ){
		...
		if(data.result === true){
			...
			statusElement.attr('class','lwa-status lwa-status-invalid').html('Internet com problemas.<br/> Tente novamente em alguns minutos, se precisar de ajuda <a href="/fale-conosco" class="click-loading">clique aqui</a>'); //modify status content
		}
	}
