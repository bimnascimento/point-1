 ...
 */
   ...
   if ($show_part_of_iframe == 'true') {
       $html .= '
        ...
        #'.$id.' {
            position : absolute;
            top      : -'.esc_html($this->addPx($show_part_of_iframe_y)). ($css_important).';
            left     : -'.esc_html($this->addPx($show_part_of_iframe_x)). ($css_important).';
            width    : '.esc_html($this->addPx($width)). ($css_important).';
            height   : '.esc_html($this->addPx($height)). ($css_important).';
        }';
   }
