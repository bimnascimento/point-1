...
function dokan_site_total_earning() {
    ...
    $sql = "SELECT  SUM((do.order_total - do.net_amount)) as earning
            ...
            WHERE seller_id != 0 AND p.post_status = 'publish' AND do.order_status IN ('wc-on-hold', 'wc-completed', 'wc-processing', 'wc-pagamento-ok', 'wc-saiu-para-entrega', 'wc-saiu-para-coleta', 'wc-lavando-pecas')
...
function dokan_admin_report( $group_by = 'day', $year = '' ) {
    ...
    $sql = "SELECT
            ...
            WHERE
                ...
                do.order_status IN ('wc-on-hold', 'wc-completed', 'wc-processing', 'wc-pagamento-ok', 'wc-saiu-para-entrega', 'wc-saiu-para-coleta', 'wc-lavando-pecas')
                $date_where
