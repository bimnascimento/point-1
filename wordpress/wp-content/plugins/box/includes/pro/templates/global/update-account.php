...
<form method="post" action="" id='migrar-conta'>
    ...
    <div class="dokan-become-seller">
        ...
        <?php wp_nonce_field( 'account_migration', 'dokan_nonce' ); ?>
            ...
            <input type="submit" class="woocommerce-Button button btn-lg pt-right" name="dokan_migration" value="<?php _e( 'Become a Seller', 'dokan' ); ?>" />
        </p>
