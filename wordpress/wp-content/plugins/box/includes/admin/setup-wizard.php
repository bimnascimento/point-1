...
class Dokan_Setup_Wizard {
    ...
    public function get_next_step_link() {
        ...
        return add_query_arg( 'passo', $keys[ array_search( $this->step, array_keys( $this->steps ) ) + 1 ] );
    }

    public function get_reload_step_link() {
        $keys = array_keys( $this->steps );
        return add_query_arg( 'passo', $keys[ array_search( $this->step, array_keys( $this->steps ) ) ] );
    }
    ...
    public function setup_wizard_header() {
        ...
        <head>
            ...
            <style type="text/css">
                ...
                html {
                    background: top 130% right 100% no-repeat,linear-gradient(hsl(215, 59%, 49%),#1561a4 33.19%,rgb(31, 100, 167) 81.51%,hsl(212, 47%, 41%)) no-repeat fixed;
                    margin: 0 20px;
                    height: 100%;
                }
                .wc-setup-content {
