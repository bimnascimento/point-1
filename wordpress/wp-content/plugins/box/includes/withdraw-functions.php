...
function dokan_withdraw_method_bank( $store_settings ) {
    $account_razao_social   = isset( $store_settings['payment']['bank']['razao_social'] ) ? esc_attr( $store_settings['payment']['bank']['razao_social'] ) : '';
    $account_cnpj   = isset( $store_settings['payment']['bank']['cnpj'] ) ? esc_attr( $store_settings['payment']['bank']['cnpj'] ) : '';
    $account_ie   = isset( $store_settings['payment']['bank']['ie'] ) ? esc_attr( $store_settings['payment']['bank']['ie'] ) : '';
    ...
    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input name="settings[bank][razao_social]" value="<?php echo $account_razao_social; ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Razão Social', 'dokan' ); ?>" type="text">
        </div>
    </div>
    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input name="settings[bank][cnpj]" value="<?php echo $account_cnpj; ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'CNPJ', 'dokan' ); ?>" type="text">
        </div>
    </div>
    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input name="settings[bank][ie]" value="<?php echo $account_ie; ?>" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Inscrição Estadual', 'dokan' ); ?>" type="text">
        </div>
    </div>
