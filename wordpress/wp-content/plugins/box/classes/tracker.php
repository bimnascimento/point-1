...
class Dokan_Tracker extends WeDevs_Insights {
    ...
    protected function get_order_count() {
        ...
        return (int) $wpdb->get_var( "SELECT count(ID) FROM $wpdb->posts WHERE post_type = 'shop_order' and post_status IN ('wc-completed', 'wc-processing', 'wc-on-hold', 'wc-refunded', 'wc-pagamento-ok', 'wc-saiu-para-entrega', 'wc-saiu-para-coleta', 'wc-lavando-pecas');");
    }
