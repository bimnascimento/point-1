...
class Dokan_Template_Settings {
    ...
    function __construct() {
        ...
        add_action( 'dokan_settings_content_area_header', array( $this, 'render_settings_header' ), 9 );
        add_action( 'dokan_settings_content_area_header', array( $this, 'render_settings_load_progressbar' ), 10 );
            ...
            foreach ( $dokan_settings['social'] as $key => $value ) {
                ...
                if ( isset( $social_val[$key] ) && $value == false ) {
                    ...
                    if ( strlen( $next_add ) == 0 ) {
                        ...
                        //$nice_name = ( $key === 'fb' ) ? __( 'Facebook', 'dokan' ) : '' ;
