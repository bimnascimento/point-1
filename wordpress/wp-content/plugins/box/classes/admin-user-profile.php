...
class Dokan_Admin_User_Profile {
    ...
    function add_meta_fields( $user ) {
        ...
        $address_endereco     = isset( $store_settings['address']['endereco'] ) ? $store_settings['address']['endereco'] : '';
        $address_bairro     = isset( $store_settings['address']['bairro'] ) ? $store_settings['address']['bairro'] : '';
        $address_numero     = isset( $store_settings['address']['numero'] ) ? $store_settings['address']['numero'] : '';
        $address_complemento     = isset( $store_settings['address']['complemento'] ) ? $store_settings['address']['complemento'] : '';
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    <th><?php _e( 'Endereco', 'dokan' ); ?></th>
                    <td>
                        <input type="text" name="dokan_store_address[endereco]" class="regular-text" value="<?php echo esc_attr( $address_endereco ) ?>">
                    </td>
                </tr>
                <tr>
                    <th><?php _e( 'Número', 'dokan' ); ?></th>
                    <td>
                        <input type="text" name="dokan_store_address[numero]" class="regular-text" value="<?php echo esc_attr( $address_numero ) ?>">
                    </td>
                </tr>
                <tr style="display:none;">
                    <th><?php _e( 'Complemento', 'dokan' ); ?></th>
                    <td>
                        <input type="text" name="dokan_store_address[complemento]" class="regular-text" value="<?php echo esc_attr( $address_complemento ) ?>">
                    </td>
                </tr>
                <tr>
                    <th><?php _e( 'Bairro', 'dokan' ); ?></th>
                    <td>
                        <input type="text" name="dokan_store_address[bairro]" class="regular-text" value="<?php echo esc_attr( $address_bairro ) ?>">
                    </td>
                </tr>
                ...
                <?php if( isset( $store_settings['payment']['bank'] ) ) { ?>
                  <tr>
                      <th><?php _e( 'Razão Social ', 'dokan' ); ?></th>
                      <td>
                          <input type="text" disabled class="regular-text" value="<?php echo esc_attr( $store_settings['payment']['bank']['razao_social'] ); ?>">
                      </td>
                  </tr>
                  <tr>
                      <th><?php _e( 'Cnpj ', 'dokan' ); ?></th>
                      <td>
                          <input type="text" disabled class="regular-text" value="<?php echo esc_attr( $store_settings['payment']['bank']['cnpj'] ); ?>">
                      </td>
                  </tr>
                  <tr>
                      <th><?php _e( 'Inscrição Estadual ', 'dokan' ); ?></th>
                      <td>
                          <input type="text" disabled class="regular-text" value="<?php echo esc_attr( $store_settings['payment']['bank']['ie'] ); ?>">
                      </td>
                  </tr>
                  <tr>
