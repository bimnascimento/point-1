...
<div class="table-responsive">
        <table class="meus-pedidos shop_table my_account_orders table table-striped ">

            <thead>
                <tr>
                    <th class="order-number2"><span class="nobr"><?php _e( 'Order', 'dokan' ); ?></span></th>
                ...
                foreach ( $customer_orders as $customer_order ) {
                    ...
                    ?><tr class="order">
                        <td class="order-number">
                            <a href="<?php echo $order->get_view_order_url(); ?>" class="click-loading">
                        ...
                        <td class="order-total">
                            <?php
                                ...
                                if ( $seller_id && $seller_id != 0 ) {
                                    ...
                                    echo '<a class="click-radar" href="'. dokan_get_store_url( $seller_id ) .'">'. $sellershop['store_name'] .'</a>';
                                } else {
                        ...
                        <td class="order-actions">
                            <?php
                                ...
                                foreach( $actions as $key => $action ) {
                                    echo '<a href="' . esc_url( $action['url'] ) . '" class="click-loading button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
                                }
                            ?>
                        </td>
                    </tr><?php
