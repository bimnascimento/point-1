...
<?php
    ...
    $setting_minimum_order_amount = isset( $profile_info['setting_minimum_order_amount'] ) ? esc_attr( $profile_info['setting_minimum_order_amount'] ) : '';
    $setting_order_percentage = isset( $profile_info['setting_order_percentage'] ) ? esc_attr( $profile_info['setting_order_percentage'] ) : '';
    ...
    */
    ...
    if(!$map_location){
        //$map_address = $address_street1.','.$address_city;
        //$map_location = "-21.761391, -43.349583";
    }
...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <div class="dokan-form-group dokan_gravatar-div">
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_store_name"><?php _e( 'Store Name', 'dokan' ); ?><span class="required"> *</span></label>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="setting_phone"><?php _e( 'Phone No', 'dokan' ); ?><span class="required"> *</span></label>
            <div class="dokan-w5 dokan-text-left">
                <input id="setting_phone" value="<?php echo $phone; ?>" name="setting_phone" placeholder="<?php _e( '+123456..', 'dokan' ); ?>" class="dokan-form-control input-md telefone" type="text">
            </div>
        </div>
        ...
        <?php else: ?>
          <input type="hidden" name="setting_show_minimum_discount_option" value="no">
          <input id="lbl_setting_minimum_quantity" type="hidden" name="setting_show_minimum_order_discount_option" value="no">
          <input id="setting_minimum_order_amount" value="<?php echo $setting_minimum_order_amount; ?>" name="setting_minimum_order_amount" type="hidden">
          <input id="setting_order_percentage" value="<?php echo $setting_order_percentage; ?>" name="setting_order_percentage" type="hidden">
         <?php endif; ?>
...
<script type="text/javascript">
    ...
    (function($) {
      ...
      jQuery('#store-form').on('keypress', function(e) {
