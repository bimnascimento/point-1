...
class like_box_widget_facbook extends WP_Widget {
	...
	// function to update Widget Like Box Settings //
	...
	/* Widget Facebook Like Box admin page opions function */
	...
	public function generete_facbook_widget_page($params){
		...
		$facbook_front.="</a></blockquote></div></div>";
	        /*this is an promotion link for our plugin, if you don't like it just remove it, this link doesn't hurm your website, so don't worry about this, thank you for your understanding*/
