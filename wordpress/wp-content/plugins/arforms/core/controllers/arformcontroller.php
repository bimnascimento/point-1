...
class arformcontroller {
            ...
            if (!current_user_can('arfdeleteforms')) {
                ...
                if (is_array($ids)) {
                    ...
                    if ($bulkaction == 'delete') {
                        ...
                        if ($res_var) {
                            $message = __('Record is deleted successfully.', 'ARForms');
                        }
                    }
                }
            }
    ...
    function head() {
        ...
        $js_file = array(ARFURL . '/js/jquery/jquery-ui-themepicker.js?ver=' . $arfversion, ARFURL . '/js/jquery/jquery.editinplace.packed.js?ver=' . $arfversion);
    ...
    function edit($popup_preview = '') {
        ...
        if ($recs) {
            ...
            do_action('arf_autoresponder_ref_update', $id, $res_rec, $resrpw['id']);
	    ...
	    do_action('arf_autoresponder_ref_update', $id, $res_rec, $record);
    ...
    function update($is_preview = '') {
        ...
        global $arfform, $wpdb, $MdlDb, $armainhelper, $arsettingcontroller, $arfsettings;
        ...
        if (count($errors) > 0) {
            ...
            if (count($form_chk_res) == 0) {
                echo '<script type="text/javascript" data-cfasync="false">location.href="' . admin_url('admin.php?page=ARForms&err=1') . '";</script>';
            }
            ...
            $message = __('Form is successfully updated - w"p"l"o"C"k"e:r."c"o"m', 'ARForms');
    ...
    function arfgetapiurl() {
        $api_url = 'https://arformsplugin.com/arf/arforms_update/arforms_api/index.php';
        return $api_url;
    }
    ...
    function get_edit_vars($id, $errors = '', $message = '', $create_link = false, $template_id = '', $popup_preview = '', $is_ref_form = 0) {
        ...
        $edit_message = __('Form is Successfully Updated - w"p"l"o"C"k"e:r."c"o"m', 'ARForms');
    ...
    function change_form_listing($message = '', $errors = '') {
        ...
        <th class="arf_col_action" style="width:230px;"><?php _e('Action', 'ARForms'); ?></th>
        </tr>
        </thead>
        <tbody>
            <?php
            ...
            foreach ($form_result as $key => $val) {
                ...
                ?>">
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td class="arf_col_action" style="width:230px;">
                        <div class="arf-row-actions">
                            ...
                            if (current_user_can('arfeditforms')) {
                                ...
                                echo "<a href='" . wp_nonce_url($edit_link) . "'><img alt='' src='" . ARFIMAGESURL . "/edit-icon22.png' onmouseover=\"this.src='" . ARFIMAGESURL . "/edit-icon_hover22.png';\" class='arfhelptip' title='" . __('Edit Form', 'ARForms') . "' onmouseout=\"this.src='" . ARFIMAGESURL . "/edit-icon22.png';\" /></a>";
                            ...
                            if (current_user_can('arfeditforms')) {
                                ...
                                echo "<a href='" . wp_nonce_url("?page=ARForms-entries&arfaction=list&form={$val->id}") . "'><img alt='' src='" . ARFIMAGESURL . "/listing_icon22.png' title='" . __('Form Entry', 'ARForms') . "'  class='arfhelptip' onmouseover=\"this.src='" . ARFIMAGESURL . "/listing_icon_hover22.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/listing_icon22.png';\" /></a>";

                                echo "<a href='" . wp_nonce_url($duplicate_link) . "'><img alt='' src='" . ARFIMAGESURL . "/duplicate-icon22.png' title='" . __('Duplicate Form', 'ARForms') . "'  class='arfhelptip' onmouseover=\"this.src='" . ARFIMAGESURL . "/duplicate-icon_hover22.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/duplicate-icon22.png';\" /></a>";

                                echo "<a href='javascript:void(0);' onclick='arfaction_func(\"export_csv\", \"{$val->id}\");'><img alt='' src='" . ARFIMAGESURL . "/export.png' title='" . __('Export To CSV', 'ARForms') . "' class='arfhelptip' onmouseover=\"this.src='" . ARFIMAGESURL . "/export_hover.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/export.png';\" /></a>";
                            }
                            ...
                            if (current_user_can('arfdeleteforms')) {
                                ...
                                $id = $val->id;
                                echo "<img alt='' src='" . ARFIMAGESURL . "/delete_icon222.png' title='" . __('Delete', 'ARForms') . "' onmouseover=\"this.src='" . ARFIMAGESURL . "/delete_icon2_hover222.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/delete_icon222.png';\" data-toggle='arfmodal' href='#delete_form_message' onclick=\"ChangeID({$id});arfchangedeletemodalwidth('arfdeletemodabox');\" class='arfhelptip' style='cursor:pointer'/></a>";
                            }
                            ...
                            $target_url = $arformhelper->get_direct_link($val->form_key);
                            echo "<a class='openpreview' href='javascript:void(0)' data-url='" . $target_url . $tb_width . $tb_height . "&whichframe=preview&TB_iframe=true&ptype=list'><img alt='' src='" . ARFIMAGESURL . "/view_icon22.png'  onmouseover=\"this.src='" . ARFIMAGESURL . "/view_icon_hover22.png';\" title='" . __('Preview', 'ARForms') . "' class='arfhelptip' onmouseout=\"this.src='" . ARFIMAGESURL . "/view_icon22.png';\" /></a>";
                            ?>
        ...
        <script type="text/javascript" data-cfasync="false">
            jQuery(document).ready(function ($) {
                ...
                $('a[class="openpreview"]').click(function () {
                    ...
                    $('#form_preview_modal #arfdevicepreview').load(function () {
                        $('.iframe_loader').attr("style", 'display:none');
    ...
    function arfupdateactionfunction() {
        ...
        if ($action == 'export_csv') {
            echo '<script type="text/javascript" data-cfasync="false">location.href="' . site_url() . '/index.php?plugin=ARForms&controller=entries&form=' . $id . '&arfaction=csv";</script>';
        }
    ...
    function global_reset_style_setting() {
        ...
        global $arfadvanceerrcolor, $armainhelper, $arformhelper, $arrecordcontroller, $arformcontroller,$arfversion;
        $id = $_POST['form'];
        ...
        <ul class="frm_styling_icons">
            <li>
                ...
                if ($browser_info['name'] == 'Internet Explorer' and $browser_info['version'] <= '8') {
                                ...
                                <div class="widget-inside" style="display: block;">
                                    ...
                                    <div class="field-group clearfix widget_bg_bottom" style="margin-top:10px;">
                                        ...
                                        <div class="sltstandard1"  style=" <?php echo $frm_align_opt_css; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" class="toggle-btn left <?php
                                                if ($newarr['form_align'] == "left") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffa" class="visuallyhidden" value="left" <?php checked($newarr['form_align'], 'left'); ?> /><?php _e('Left', 'ARForms') ?></label><label onclick="" class="toggle-btn center <?php
                                                       if ($newarr['form_align'] == "center") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arffa"  class="visuallyhidden" value="center" <?php checked($newarr['form_align'], 'center'); ?> /><?php _e('Center', 'ARForms') ?></label><label onclick="" class="toggle-btn right <?php
                                                           if ($newarr['form_align'] == "right") {
                                                               echo "success";
                                                           }
                                                           ?>"><input type="radio" name="arffa" class="visuallyhidden" value="right" <?php checked($newarr['form_align'], 'right'); ?> /><?php _e('Right', 'ARForms') ?></label>
                                            </div>
                                        ...
                                        <div id="form_bg_img_div" <?php if ($browser_info['name'] == 'Internet Explorer' and $browser_info['version'] <= '9') { ?> class="iframe_original_btn" data-id="arfmfbi" style="margin-left:5px; position: relative; overflow: hidden; float:left; cursor:pointer; max-width:140px; height:22px; background: #1BBAE1; font-weight:bold; <?php if ($newarr['arfmainform_bg_img'] == '') { ?> background:#1BBAE1;padding: 7px 10px 0 10px;font-size:13px;border-radius:3px;color:#FFFFFF;border:1px solid #CCCCCC; <?php } ?>" <?php } else { ?> style="margin-left:0px;" <?php } ?>  >
                                            ...
                                            if ($browser_info['name'] == 'Internet Explorer' and $browser_info['version'] <= '9') {
                                                if ($newarr['arfmainform_bg_img'] != '') {
                                                    ?>
                                                    <img alt='' src="<?php echo $newarr['arfmainform_bg_img']; ?>" height="30" width="100" style="margin-left:5px;" />&nbsp;<img alt='' style="cursor:pointer; vertical-align:super;" onclick="delete_form_bg_img();" src="<?php echo ARFURL . '/images/delete-icon.png'; ?>" />
                                                ...
                                                <?php if ($newarr['arfmainform_bg_img'] != '') { ?>
                                                    <img alt='' src="<?php echo $newarr['arfmainform_bg_img']; ?>" height="30" width="100" style="margin-left:5px;" />&nbsp;<img style="cursor:pointer; vertical-align:super;" onclick="delete_form_bg_img();" src="<?php echo ARFURL . '/images/delete-icon.png'; ?>" />
                                                    <input type="hidden" name="arfmfbi" onclick="clear_file_submit();" value="<?php echo esc_attr($newarr['arfmainform_bg_img']) ?>" id="arfmainform_bg_img" />
                                                <?php } else { ?>
                                                    ...
                                                    <input type="hidden" name="imagename_form" id="imagename_form" value="" />
                                                    <input type="hidden" name="arfmfbi" onclick="clear_file_submit();" value="" id="arfmainform_bg_img" />
                                                    &nbsp;&nbsp;<span id="ajax_form_loader" style="display:none; float: left; margin: 5px 0 0;"><img alt='' align="absmiddle" src="<?php echo ARFIMAGESURL ?>/wpspin_light.gif"></span>
                                                <?php } ?>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="field-group clearfix subfield" style="margin-top:3px;">
                                        ...
                                        <div style=" <?php echo $frm_brdr_btn; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                ...
                                                if ($newarr['form_border_shadow'] == "shadow") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffbs" class="visuallyhidden" id="arfmainformbordershadow1" value="shadow" <?php checked($newarr['form_border_shadow'], 'shadow'); ?> /><?php _e('Shadow', 'ARForms') ?></label><label onclick="" class="toggle-btn normal <?php
                                                       if ($newarr['form_border_shadow'] == "flat") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arffbs" class="visuallyhidden" value="flat"  id="arfmainformbordershadow2" <?php checked($newarr['form_border_shadow'], 'flat'); ?> /><?php _e('Flat', 'ARForms') ?></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="clear" style="margin-top:10px;">
                                        <div>
                                            ...
                                            <div style=" <?php echo $frm_title_desc_check; ?>"><label><span>HIDE&nbsp;</span></label><input type="checkbox" class="js-switch" name="options[display_title_form]" id="display_title_form" <?php
                                                if ($values_nw['display_title_form'] == '1') {
                                                    echo 'checked="checked"';
                                                }
                                                ?> onchange="change_form_title();" value="<?php echo $values_nw['display_title_form']; ?>" /><label><span>&nbsp;SHOW</span></label>
                                            </div>
                                        </div>                            
                                    </div>

                                    <input type="hidden" id="temp_display_title_form" value="1" /> 
                                    <div id="form_title_style_div" <?php
                                    ...
                                    ?>> 
                                        ...
                                        <div class="field-group clearfix subfield" style="margin-top:10px;">
                                            ...
                                            <div class="sltstandard1"style=" <?php echo $frm_title_txt_align_btn; ?>">
                                                <div class="toggle-btn-grp joint-toggle">
                                                    <label onclick="" class="toggle-btn left <?php
                                                    if ($newarr['arfformtitlealign'] == "left") {
                                                        echo "success";
                                                    }
                                                    ?>"><input type="radio" name="arffta" class="visuallyhidden" value="left" <?php checked($newarr['arfformtitlealign'], 'left') ?> /><?php _e('Left', 'ARForms'); ?></label><label onclick="" class="toggle-btn center <?php
                                                           if ($newarr['arfformtitlealign'] == "center") {
                                                               echo "success";
                                                           }
                                                           ?>"><input type="radio" name="arffta"  class="visuallyhidden" value="center" <?php checked($newarr['arfformtitlealign'], 'center') ?> /><?php _e('Center', 'ARForms'); ?></label><label onclick="" class="toggle-btn right <?php
                                                               if ($newarr['arfformtitlealign'] == "right") {
                                                                   echo "success";
                                                               }
                                                               ?>"><input  class="visuallyhidden" type="radio" name="arffta" value="right" <?php checked($newarr['arfformtitlealign'], 'right') ?> /><?php _e('Right', 'ARForms'); ?></label>
                                                </div>
                                            </div>    	
                                        </div>
                                                                ...
                                                                <dl class="arf_selectbox" data-name="arftff" data-id="arftitlefontsetting" style="width:180px;">
                                                                    ...
                                                                    <dd>
                                                                        <ul style="display: none;" data-id="arftitlefontsetting">
                                                                            ...
                                                                            <ol class="arp_selectbox_group_label"><?php _e('Google Fonts', 'ARForms'); ?></ol>
                                                                            <?php
                                    ...
                                    <div id="arf_pagebreak_style" style=" <?php
                                    if (!$is_pagebreak_form) {
                                        echo 'display:none;';
                                    }
                                    ?>">
                                    ...
                                    <div id="arf_surveypage_style" style=" <?php
                                    if ($is_pagebreak_form) {
                                        echo 'display:none;';
                                    }
                                    ?>">
                                ...
                                <div class="widget-inside">
                                        ...
                                        <div class="sltstandard1" style=" <?php echo $lbl_position_opt; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <?php foreach (array('top' => __('Top', 'ARForms'), 'left' => __('Left', 'ARForms'), 'right' => __('Right', 'ARForms')) as $pos => $pos_label) { ?>
                                                    <label onclick="" class="toggle-btn <?php echo $pos . "pos"; ?> <?php
                                                    if ($newarr['position'] == $pos) {
                                                        echo "success";
                                                    }
                                                    ?>"><input type="radio" name="arfmps" class="visuallyhidden" onchange="frmSetPosClass('<?php echo $pos; ?>')" value="<?php echo $pos ?>" <?php checked($newarr['position'], $pos) ?> /><?php echo $pos_label ?></label>	
                                                       <?php } ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="field-group clearfix widget_bg_bottom" style="margin-top:10px;">
                                        ...
                                        <div style=" <?php echo $lbl_txt_align_opt; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" class="toggle-btn left <?php
                                                if ($newarr['align'] == "left") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffrma" id="frm_align" class="visuallyhidden" value="left" <?php checked($newarr['align'], 'left'); ?> /><?php _e('Left', 'ARForms') ?></label><label onclick="" class="toggle-btn right <?php
                                                       if ($newarr['align'] == "right") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arffrma" id="frm_align_2"  class="visuallyhidden" value="right" <?php checked($newarr['align'], 'right'); ?> /><?php _e('Right', 'ARForms') ?></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="clear" style="margin-top:10px;padding-bottom:5px;">
                                        ...
                                        <div><label><span>NO&nbsp;</span></label><input type="checkbox" class="js-switch" name="arfhl" id="arfhidelabels" value="<?php echo $newarr['hide_labels'] != "" ? $newarr['hide_labels'] : 0; ?>" onchange="frmSetPosClassHide()"  <?php
                                    ...
                                    <div class="field-group clearfix subfield" style="margin-top:10px;">
                                        ...
                                        <div class="sltstandard1" style=" <?php echo $field_desc_align_opt; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                ...
                                                ?>"><input type="radio" name="arfdas" class="visuallyhidden" value="left" <?php checked($newarr['arfdescalighsetting'], 'left'); ?> /><?php _e('Left', 'ARForms') ?></label><label onclick="" class="toggle-btn center <?php
                                                       if ($newarr['arfdescalighsetting'] == "center") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arfdas"  class="visuallyhidden" value="center" <?php checked($newarr['arfdescalighsetting'], 'center'); ?> /><?php _e('Center', 'ARForms') ?></label><label onclick="" class="toggle-btn right <?php
                                                           if ($newarr['arfdescalighsetting'] == "right") {
                                                               echo "success";
                                                           }
                                                           ?>"><input type="radio" name="arfdas" class="visuallyhidden" value="right" <?php checked($newarr['arfdescalighsetting'], 'right'); ?> /><?php _e('Right', 'ARForms') ?></label>
                                            </div>
                                ...
                                <div class="widget-inside" style="visibility:visible;">
                                    ...
                                    <div class="field-group clearfix widget_bg_bottom" style="margin-top:7px;">
                                        ...
                                        <div style=" <?php echo $text_dir_btn; ?>">
                                            <div class="toggle-btn-grp joint-toggle" style=" <?php echo $text_dir_btn_sub; ?>">
                                                <label onclick="" class="toggle-btn-large <?php
                                                if ($newarr['text_direction'] == "1") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arftds" class="visuallyhidden" id="txt_dir_1" value="1" <?php checked($newarr['text_direction'], 1); ?> /><?php _e('Left to Right', 'ARForms') ?></label><label onclick="" class="toggle-btn-large <?php
                                                       if ($newarr['text_direction'] == "0") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arftds" class="visuallyhidden" value="0"  id="txt_dir_2" <?php checked($newarr['text_direction'], 0); ?> /><?php _e('Right to Left', 'ARForms') ?></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="field-group clearfix subfield" style="margin-top:10px;">
                                        ...
                                        <div class="sltstandard1" style=" <?php echo $brd_style_opt; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" style="width:55px !important;" class="toggle-btn solid <?php
                                                if ($newarr['arffieldborderstylesetting'] == "solid") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffbss" class="visuallyhidden" value="solid" <?php checked($newarr['arffieldborderstylesetting'], 'solid'); ?> /><?php _e('Solid', 'ARForms') ?></label>

                                                <label onclick="" style="width:55px !important;" class="toggle-btn dotted <?php
                                                if ($newarr['arffieldborderstylesetting'] == "dotted") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffbss"  class="visuallyhidden" value="dotted" <?php checked($newarr['arffieldborderstylesetting'], 'dotted'); ?> /><?php _e('Dotted', 'ARForms') ?></label>

                                                <label onclick="" style="width:55px !important;" class="toggle-btn dashed <?php
                                                if ($newarr['arffieldborderstylesetting'] == "dashed") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arffbss" class="visuallyhidden" value="dashed" <?php checked($newarr['arffieldborderstylesetting'], 'dashed'); ?> /><?php _e('Dashed', 'ARForms') ?></label>
                                            </div>
                                    ...
                                    <div class="clear" style="margin-top:10px;">
                                        ...
                                        <div>
                                            <label><span>NO&nbsp;</span></label><input type="checkbox" class="js-switch chkstanard" name="arfmfo" id="arfmainfield_opacity" value="<?php echo $newarr['arfmainfield_opacity']; ?>" <?php
                                            if ($newarr['arfmainfield_opacity'] == 1) {
                                                echo 'checked="checked"';
                                            }
                                            ?> /><label><span>&nbsp;YES</span></label>
                                    ...
                                    <div class="field-group clearfix subfield">
                                        ...
                                        <div class="sltstandard1" style=" <?php echo $calender_theme_opt; ?>">
                                            ...
                                            <?php $jquery_classicthemes = $armainhelper->jquery_classic_themes(); $jquery_solidthemes = $armainhelper->jquery_solid_themes(); ?>
                                            
                                            <input id="arfformsthemesettingselbx" name="arffths" value="<?php
                                            if ($newarr['arfcalthemename'] != "" && $newarr['arfcalthemename'] != "default_theme") {
                                                    echo $newarr['arfcalthemename'];
                                                } else {
                                                    echo "default_theme";
                                                }
                                            ?>" type="hidden" >
                                            <dl class="arf_selectbox" data-name="arffths" data-id="arfformsthemesettingselbx" style="width:122px;">
                                                <dt><span><?php
                                                   if ($newarr['arfcalthemename'] != "" && $newarr['arfcalthemename'] != "default_theme") {
                                                            echo $jquery_classicthemes[$newarr['arfcalthemename']];
															echo $jquery_solidthemes[$newarr['arfcalthemename']];
                                                        } else {
                                                            echo $jquery_classicthemes["default_theme"];
                                                        }
                                                    ?></span>
                                                ...
                                                <dd>
                                                    <ul style="display: none;" data-id="arfformsthemesettingselbx">
                                                        <ol class="arp_selectbox_group_label"> Classic </ol>
                                                            <?php foreach ($jquery_classicthemes as $theme_name => $theme_title) { ?>
                                                            ...
                                                            <?php } ?>
                                                            <ol class="arp_selectbox_group_label"> Solid Filled </ol>
                                                            <?php foreach ($jquery_solidthemes as $theme_name => $theme_title) { ?>
                                                                <li class="arf_selectbox_option" id="theme_<?php echo $theme_name ?>" data-value="<?php echo $theme_name ?>" data-label="<?php echo $theme_title ?>"><?php echo $theme_title ?></li>
                                                            <?php } ?>
                                    ...
                                    <div class="clearfix subfield" id="frm_check_radio_style_div">
                                        ...
                                        <div class="sltstandard1" style="float:left;">
                                            ...
                                            <input id="frm_check_radio_style" name="arfcksn" value="<?php echo $newarr['arfcheckradiostyle']; ?>" type="hidden" onchange="arf_change_check_radio();
                                                    ShowColorSelect(this.value);">
                                    ...
                                    <div class="clearfix subfield" id="check_radio_main_color" <?php if ($newarr['arfcheckradiostyle'] != "custom" && $newarr['arfcheckradiostyle'] != "none" && $newarr['arfcheckradiostyle'] != "polaris" && $newarr['arfcheckradiostyle'] != "futurico") { ?> style="display:block;margin-top:10px;" <?php
                                } else {
                                    ...
                                    if(is_rtl())
                                    {
                                            $check_radio_style_lbl1 = 'float:right;width:120px;';
                                    }
                                    else
                                    {
                                            $check_radio_style_lbl1 = 'float:left;width:120px;';
                                    }
                            ?>
                            <div class="clearfix subfield" id="check_radio_main_icon" <?php if($newarr['arfcheckradiostyle']=="custom"){?> style="display:block;margin-top:10px;" <?php }else{ echo "style='display:none;margin-top:10px;'"; }?>>
                            	<label class="lblsubheading sublblheading" style=" <?php echo $check_radio_style_lbl1; ?>"><?php _e('Icon', 'ARForms') ?></label>
                            	<div class="sltstandard1" style="float:left;">
                                    <div class="arf_field_check_radio_wrapper" id="arf_field_check_radio_wrapper">
                                        <div class="arf_check_wrapper">       
                                            <div class="arf_check_radio_container_wrapper" data-action='edit' data-field='checkbox' id="arf_edit_check" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type='checkbox'>
                                                <div class="arf_check_container" id="arf_select_checkbox">
                                                    <?php
                                                        if ($newarr['arf_checked_checkbox_icon'] != '') {
                                                            echo "<i id='arf_check_radio_icon' class='arf_check_radio_icon arfa {$newarr['arf_checked_checkbox_icon']}'></i>";
                                                        } else {
                                                            _e('No Icon', 'ARForms');
                                                        }
                                                    ?>
                                                </div>
                                                <div class="arf_check_radio_action_container">
                                                    <div class="arf_check_radio_action" title="Change Icon">
                                                        <i class="arfa arfa-caret-down arfa-lg"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="howto"> <?php _e('Check Boxes', 'ARForms'); ?> </div>
                                        </div>
                                        
                                        <div class="arf_radio_wrapper">       
                                            <div class="arf_check_radio_container_wrapper" data-action='edit' data-field='radio' id="arf_edit_radio" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type='radio'>
                                                <div class="arf_radio_container" id="arf_select_radio">
                                                    <?php
                                                        if ($newarr['arf_checked_radio_icon'] != '') {
                                                            echo "<i id='arf_check_radio_icon' class='arf_check_radio_icon arfa {$newarr['arf_checked_radio_icon']}'></i>";
                                                        } else {
                                                            _e('No Icon', 'ARForms');
                                                        }
                                                    ?>
                                            ...
                                            <div class="howto"> <?php _e('Radio Buttons', 'ARForms'); ?> </div>
                                        </div>
                                    </div>    
                                    <input type="hidden" name="enable_arf_checkbox" id="enable_arf_checkbox" value="<?php echo $newarr['enable_arf_checkbox']; ?>" />
                                    <input type="hidden" name="arf_checkbox_icon" id="arf_checkbox_icon" value="<?php echo $newarr['arf_checked_checkbox_icon']; ?>" />
                                    <input type="hidden" name="enable_arf_radio" id="enable_arf_radio" value="<?php echo $newarr['enable_arf_radio']; ?>" />
                                    <input type="hidden" name="arf_radio_icon" id="arf_radio_icon" value="<?php echo $newarr['arf_checked_radio_icon']; ?>" />
					...
					if(is_rtl())
					{
                                                $check_radio_style_lbl = 'float:right;width:130px;margin-top: 10px;';
						$check_radio_bg_col_lbl_cls = 'arf_float_left';
						$check_radio_bg_col_lbl_css = 'float:right;margin: 10px 0 0 10px;';
					}
					else
					{
                                                $check_radio_style_lbl = 'float:left;width:130px;margin-top: 10px;';
						$check_radio_bg_col_lbl_cls = 'arf_float_right';
						$check_radio_bg_col_lbl_css = 'float:left;margin: 10px 0 0 10px;';
					}
				?>
                                
                                    <label class="lblsubheading sublblheading" style=" <?php echo $check_radio_style_lbl; ?>"><?php _e('Icon Color', 'ARForms') ?></label>
                                    <div class=" <?php echo $check_radio_bg_col_lbl_cls; ?>" style=" <?php echo $check_radio_bg_col_lbl_css; ?>">

                                        <div class="arf_coloroption_sub">
                                            <div class="arf_coloroption arfhex" data-fid="checked_checkbox_icon_color" style="background:<?php echo esc_attr($newarr['checked_checkbox_icon_color']) ?>;"></div>
                                            <div class="arf_coloroption_subarrow_bg">
                                                <div class="arf_coloroption_subarrow"></div>
                                            </div>
                                        </div>
                                        <input type="hidden" name="cbscol" id="checked_checkbox_icon_color" class="txtxbox_widget hex" value="<?php echo esc_attr($newarr['checked_checkbox_icon_color']) ?>" style="width:100px;" />
                                    </div>
                                    
                                    <div class=" <?php echo $check_radio_bg_col_lbl_cls; ?>" style=" <?php echo $check_radio_bg_col_lbl_css; ?>">

                                        <div class="arf_coloroption_sub">
                                            <div class="arf_coloroption arfhex" data-fid="checked_radio_icon_color" style="background:<?php echo esc_attr($newarr['checked_radio_icon_color']) ?>;"></div>
                                            <div class="arf_coloroption_subarrow_bg">
                                                <div class="arf_coloroption_subarrow"></div>
                                            </div>
                                        </div>
                                        <input type="hidden" name="rbscol" id="checked_radio_icon_color" class="txtxbox_widget hex" value="<?php echo esc_attr($newarr['checked_radio_icon_color']) ?>" style="width:100px;" />
                                    </div>
							</div>
                                ...
                                <div class="widget-inside">
                                    ...
                                    <div class="field-group field-group-border clearfix" >
                                        ...
                                        <div style=" <?php echo $submit_align_btn; ?>" class="sltstandard1">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" class="toggle-btn normal <?php
                                                if ($newarr['arfsubmitalignsetting'] == "fixed") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfmsas" class="visuallyhidden" id="frm_submit_align_1" value="fixed" <?php checked($newarr['arfsubmitalignsetting'], 'fixed'); ?> /><?php _e('Fixed', 'ARForms') ?></label><label onclick="" class="toggle-btn normal <?php
                                                       if ($newarr['arfsubmitalignsetting'] == "auto") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arfmsas" id="frm_submit_align_2"  class="visuallyhidden" value="auto" <?php checked($newarr['arfsubmitalignsetting'], 'auto'); ?> /><?php _e('Auto', 'ARForms') ?></label>
                                            </div>
                                        </div>    
                                    ...
                                    <div class="field-group field-group-border clearfix  subfield" style="margin-bottom:10px; padding-top:5px;">
                                        ...
                                        <div class=" <?php echo $submit_btn_text_cls; ?>" style=" <?php echo $submit_btn_text_css; ?>">
                                            <input type="text" name="arfsubmitbuttontext" id="arfsubmitbuttontext" style="width:142px;" onkeyup="arfsetsubmitautowdith2();" onchange="arfchangesubmitvalue();
                                                    arfsetsubmitautowdith2();" class="txtxbox_widget" value="<?php echo $submit_value; ?>"  size="5" />
                                        </div>
                                ...
                                <div class="widget-inside <?php echo $validation_style_wrapper_cls; ?>" style="border-bottom: 1px solid #CACACA !important;">
                                    ...
                                    <div class="field-group field-group-border clearfix subfield" style="margin-top:10px;">
                                        ...
                                        <div style=" <?php echo $validation_err_type_btns; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" class="toggle-btn normal <?php
                                                $newarr['arferrorstyle'] = isset($newarr['arferrorstyle']) ? $newarr['arferrorstyle'] : 'normal';
                                                if ($newarr['arferrorstyle'] == "advance") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfest" class="visuallyhidden" id="arferrorstyle1" onchange="arf_change_error_type();" value="advance" <?php checked($newarr['arferrorstyle'], 'advance'); ?> /><?php _e('Advance', 'ARForms') ?></label><label onclick="" class="toggle-btn normal <?php
                                                       if ($newarr['arferrorstyle'] == "normal") {
                                                           echo "success";
                                                       }
                                                       ?>"><input type="radio" name="arfest" onchange="arf_change_error_type();" class="visuallyhidden" value="normal"  id="arferrorstyle2" <?php checked($newarr['arferrorstyle'], 'normal'); ?> /><?php _e('Normal', 'ARForms') ?></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="field-group field-group-border clearfix subfield" style="margin-top:10px;">                                
                                        ...
                                        <div id="color_palate_advance" class="arf_float_right" style=" <?php
                                        if ($newarr['arferrorstyle'] != "advance") {
                                            echo "display:none;";
                                        }
                                        ?>float:left;margin-left:59px;">
                                            <div class="toggle-btn-grp-color joint-toggle">
                                                ...
                                                foreach ($arfadvanceerrcolor as $colorname => $color_value) {
                                                    ...
                                                    ?>
                                                    <label onclick="" class="toggle-btn-color <?php
                                                    $newarr['arferrorstylecolor'] = isset($newarr['arferrorstylecolor']) ? $newarr['arferrorstylecolor'] : '';
                                                    if ($newarr['arferrorstylecolor'] == $color_value) {
                                                        echo "success";
                                                    }
                                                    ?>"><input type="radio" name="arfestc" class="visuallyhidden" value="<?php echo $color_value; ?>" <?php checked($newarr['arferrorstylecolor'], $color_value); ?> /><span style="background-color:<?php echo $boxcolor; ?>; width:16px; height:16px;">&nbsp;&nbsp;&nbsp;&nbsp;</span></label>
                                                           <?php
                                                       }
                                                       ?>
                                            </div>
                                        ...
                                        <div id="color_palate_normal" class="arf_float_right" style=" <?php
                                        if ($newarr['arferrorstyle'] != "normal") {
                                            echo "display:none;";
                                        }
                                        ?>float:left;margin-left:59px;">
                                            <div class="toggle-btn-grp-color joint-toggle">
                                                ...
                                                foreach ($arfadvanceerrcolor as $colorname => $color_value) {
                                                    ...
                                                    ?>
                                                    <label onclick="" class="toggle-btn-color <?php
                                                    $newarr['arferrorstylecolor'] = isset($newarr['arferrorstylecolor2']) ? $newarr['arferrorstylecolor2'] : '';
                                                    if ($newarr['arferrorstylecolor2'] == $color_value) {
                                                        echo "success";
                                                    }
                                                    ?>"><input type="radio" name="arfestc2" class="visuallyhidden" value="<?php echo $color_value; ?>" <?php checked($newarr['arferrorstylecolor2'], $color_value); ?> /><span style="background-color:<?php echo $boxcolor; ?>; width:16px; height:16px;">&nbsp;&nbsp;&nbsp;&nbsp;</span></label>
                                                           <?php
                                                       }
                                                       ?>
                                            </div>
                                    ...
                                    ?>
                                    <div class="field-group field-group-border clearfix subfield" id="showadvanceposition" style="margin-top:10px;<?php
                                    if ($newarr['arferrorstyle'] != "advance") {
                                        echo "display:none;";
                                    }
                                    ?>">                               
                                        ...
                                        <div class="arf_float_right" style=" <?php echo $err_validation_position_btns; ?>">
                                            <div class="toggle-btn-grp joint-toggle">
                                                <label onclick="" style="width:55px !important; text-align:center; margin-left:0;" class="toggle-btn-pos toppos <?php
                                                $newarr['arferrorstyleposition'] = isset($newarr['arferrorstyleposition']) ? $newarr['arferrorstyleposition'] : 'right';
                                                if ($newarr['arferrorstyleposition'] == "top") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfestbc" class="visuallyhidden" id="arfestbc1" value="top" <?php checked($newarr['arferrorstyleposition'], 'top'); ?> onchange="arf_change_error_position()" /><?php _e('Top', 'ARForms') ?></label>
                                                <label onclick="" style="width:55px !important; text-align:center;" class="toggle-btn-pos bottompos <?php
                                                if ($newarr['arferrorstyleposition'] == "bottom") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfestbc" class="visuallyhidden" value="bottom"  id="arfestbc2" <?php checked($newarr['arferrorstyleposition'], 'bottom'); ?> onchange="arf_change_error_position()" /><?php _e('Bottom', 'ARForms') ?></label>
                                                <label onclick="" style="width:55px !important; text-align:center;" class="toggle-btn-pos leftpos <?php
                                                if ($newarr['arferrorstyleposition'] == "left") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfestbc" class="visuallyhidden" value="left"  id="arfestbc3" <?php checked($newarr['arferrorstyleposition'], 'left'); ?> onchange="arf_change_error_position()" /><?php _e('Left', 'ARForms') ?></label>
                                                <label onclick="" style="width:55px !important; text-align:center;" class="toggle-btn-pos rightpos <?php
                                                if ($newarr['arferrorstyleposition'] == "right") {
                                                    echo "success";
                                                }
                                                ?>"><input type="radio" name="arfestbc" class="visuallyhidden" value="right"  id="arfestbc4" <?php checked($newarr['arferrorstyleposition'], 'right'); ?> onchange="arf_change_error_position()" /><?php _e('Right', 'ARForms') ?></label>
                                            </div>
                                        </div>                                
                                    </div>
                            ...
                            <div class="buttons-row" style="padding-top:10px; margin-bottom:5px; margin-left:20px; width:300px;">
                                ...
                                <button class="blueresetbtn" style="" type="button" onclick="reset_global_styling_settings_modal();" ><img src="<?php echo ARFIMAGESURL . '/reset-icon.png'; ?>" align="absmiddle" />&nbsp;&nbsp;<?php _e('Reset', 'ARForms') ?>&nbsp;&nbsp;</button>	
        ...
        if (version_compare($GLOBALS['wp_version'], '3.7', '<')) {
            wp_register_script('arffiledrag', ARFURL . '/js/filedrag/filedrag_lower.js', array(), $arfversion);
        ...
        <script type="text/javascript">
            ...
            jQuery('.widget-top,a.widget-action').click(function () {
                ...
                if (jQuery(this).closest('div.widget').children('.widget-inside').css('display') == "block") {
                    jQuery(this).closest('div.widget').removeClass('current_widget');
                }
        ...
        <?php } ?>
            ...
            {
                if (checkradiosty != "custom" && checkradiosty != "none" && checkradiosty != "futurico" && checkradiosty != "polaris")
                {
        ...
        <?php
        wp_register_script('ui-themepicker', ARFURL . '/js/jquery/jquery-ui-themepicker.js', array(), $arfversion);
    ...
    function arfverifypurchasecode() {
        ...
        if (!isset($_POST["domain_name"]) || $_POST["domain_name"] == "" || $_SERVER["SERVER_NAME"] != $_POST["domain_name"]) {
