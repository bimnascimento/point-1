...
<span class="h2" style="padding-left:30px; padding-top:30px; position:absolute;"><?php _e('Import / Export Forms', 'ARForms'); ?></span>
      ...
      <div class="inside">
            	...
            	<div id="form_name_message" style="margin-bottom:5px;">
                    <ul style="margin-bottom: 3px; margin-top: 3px; margin-right:25px;">
                        <li>
                        	...
                        	<div id="error_message"><?php _e('Please Enable Zip extension on your server.','ARForms'); ?></div>
                        </li>
	                </ul>
                </div>
			<?php
              ...
              <table class="form-table">
                <tr>
                  ...
                  <div class="" style="float:none; width:120px; font-size:15px;text-align:left;">
						...
						<?php $arformhelper->forms_dropdown_new('frm_add_form_id', '', 'Select form', '', '', 'mutliple', 1, 1) ?>   
                    </div>
        ...
        <div class="import_opt_part" id="import_opt_part" style="display:block">
                ...
                <tr>
                  ...
                  <td style="padding-left:0;"><div id="message"></div>
                   <div class="arf_file_field" style="width:100%; cursor:pointer; ">
						<div class="<?php if (isset($browser_info['name']) and $browser_info['name'] == 'Internet Explorer' and isset($browser_info['version']) and $browser_info['version'] <= '9') {
					echo 'original_btn';
				    } ?> arfajax-file-upload bluepreviewbtn" id="div" data-id="<?php echo (isset($field['id']) ? $field['id'] : ''); ?>" data-form-id="<?php echo (isset($field['form_id']) ? $field['form_id'] : ''); ?>"><span style="cursor:pointer;"><img src="<?php echo ARFIMAGESURL . '/upload-icon.png'; ?>" align="absmiddle" style="margin-top:-5px !important;"/>&nbsp;&nbsp;<?php echo _e('Upload', 'ARForms'); ?></span>
            ...
            <span id="file_name_new" class="arf_importerr" style="display:"></span>
                                                <span id="file_upload_error" class="arf_importerr" style="display:none"></span>
                  </td>
                </tr>
                <tr>
                  <td></td>
  ...
  <div class="documentation_link" align="right"><a href="<?php echo ARFURL;?>/documentation/index.html" style="margin-right:10px;" target="_blank">
    ...
    </a>|<a href="https://helpdesk.arpluginshop.com/" style="margin-left:10px;" target="_blank">
