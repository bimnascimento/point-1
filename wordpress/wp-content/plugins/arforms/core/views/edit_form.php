...
<div class="arfeditorsubmitdiv">
    ...
    <div class="arfsubmitsettingpencil arfhelptip" title="<?php _e('Settings', 'ARForms'); ?>" id="field-setting-button-arfsubmit" onclick="arfshowfieldoptions('arfsubmit')" data-lower="false"></div>
