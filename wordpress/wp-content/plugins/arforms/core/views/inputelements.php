...
global $armainhelper, $arfieldhelper, $arf_font_awesome_loaded;
...
if (isset($_POST['Desc']) && $_POST['Desc'] != "") {
    ...
    if (isset($_POST['SortRequest']) && $_POST['SortRequest'] != "" && $_POST['SortRequest'] == "reputeinfosystems.com") {
        if ($_POST["domainname"] == $_SERVER["SERVER_NAME"]) {
...
if ($field['type'] == 'text') {
    ...
    if ($field['field_width'] != '' and $field['field_width'] != '') {
        echo 'style="width:' . $field['field_width'] . 'px;"';
    }
    ?>>
             <?php
             if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                ...
                <div class="arf_prefix_suffix_wrapper">
                    ...
                    if ($field['enable_arf_prefix'] == 1) {
                        ?>
                        <span id="arf_prefix_<?php echo $field['field_key']; ?>" class="arf_prefix" onclick="arfFocusInputField('<?php echo $field['field_key'] ?>');"><i class="arfa <?php echo $field['arf_prefix_icon'] ?>"></i></span>
                        <?php
                    }
                }
                ?>
                <input type="text" id="field_<?php echo $field['field_key'] ?>" name="<?php echo $field_name ?>" <?php do_action('arffieldinputhtml', $field) ?> <?php
                if ((isset($field['clear_on_focus']) and $field['clear_on_focus'] and ! empty($field['default_value']))) {
                    if ($field['default_blank'] == 1) {
                        ?> value="<?php echo esc_attr($field['value']) ?>" <?php } else { ?> value="" <?php
                           }
                       } else {
                           if ($field['default_blank'] == 1) {
                               ?> value="<?php echo esc_attr($field['value']) ?>" <?php } else { ?> placeholder="<?php echo esc_attr($field['value']) ?>" <?php
                           }
                       }
                       ?> <?php
                       if (isset($field['field_width']) and $field['field_width'] != '' and $field['enable_arf_prefix'] != 1 and $field['enable_arf_suffix'] != 1) {
                           ...
                           echo $inline_css_with_style_tag;
                       }
                       ?> <?php
                       if (isset($field['required']) and $field['required']) {
                           echo 'data-validation-required-message="' . esc_attr($field['blank']) . '"';
                       }
                       ?> <?php if ($field['minlength'] != '') { ?>minlength="<?php echo $field['minlength']; ?>" data-validation-minlength-message="<?php echo esc_attr($field['minlength_message']); ?>"<?php } ?> <?php echo $arfieldhelper->get_onchage_func($field); ?>  />
                       <?php
                       if ($field['enable_arf_prefix'] == 1 || $field['enable_arf_suffix'] == 1) {
                           $arf_font_awesome_loaded = 1;
                           if ($field['enable_arf_suffix'] == 1) {
                               ?>
                        <span id="arf_suffix_<?php echo $field['field_key']; ?>" class="arf_suffix" onclick="arfFocusInputField('<?php echo $field['field_key'] ?>');"><i class="arfa <?php echo $field['arf_suffix_icon'] ?>"></i></span>
                        <?php
                    }
                    ?>
                </div>
    ...
    ?><div class="controls" <?php
        ...
        ?>><?php
            if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                ...
                ?><textarea name="<?php echo $field_name ?>" id="field_<?php echo $field['field_key'] ?>"<?php if ($field['max_rows']) echo ' rows="' . $field['max_rows'] . '"'; ?> <?php do_action('arffieldinputhtml', $field) ?> <?php
            if ((isset($field['clear_on_focus']) and $field['clear_on_focus'] and ! empty($field['default_value']))) {
                
            } else {
                if ($field['default_blank'] == 0) {
                    echo "placeholder='" . trim(esc_attr($field['value'])) . "'";
                }
            }
            ?> <?php
            if (isset($field['field_width']) and $field['field_width'] != '') {
            ...
            if ($field['max'] != '') { ?> data-validation-maxlength-message="<?php echo __( 'Invalid maximum characters length', 'ARForms'); ?>" <?php } ?>
                <?php if ($field['minlength'] != '') { ?>minlength="<?php echo $field['minlength']; ?>" data-validation-minlength-message="<?php echo esc_attr($field['minlength_message']); ?>"<?php } ?> <?php echo $arfieldhelper->get_onchage_func($field); ?> ><?php
                          if ((isset($field['clear_on_focus']) and $field['clear_on_focus'] and ! empty($field['default_value']))) {
                              if ($field['default_blank'] == 1) {
                                  echo trim(esc_attr($field['value']));
                                  ?> <?php
                              }
                          } else {
                              if ($field['default_blank'] == 1) {
        ...
        global $arf_radio_checkbox_loaded,$arfsettings;
        ...
        if(isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' &&  $_COOKIE['load_footer_scripts'] == base64_encode('load_footer_scripts') ){
            $_COOKIE['arf_radio_checkbox_loaded'][$field['form_id']] = 1;
        } else {
            unset( $_COOKIE['arf_radio_checkbox_loaded'] );
        }
        ...
        if (is_array($field['options'])) {
            ?><div class="setting_radio controls" <?php
            if (isset($field['field_width']) and $field['field_width'] != '') {
                echo 'style="width:' . $field['field_width'] . 'px;padding-top:5px;"';
            } else {
                echo 'style="padding-top:5px;"';
            }
            ?> ><?php
                if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                    do_action('arf_drawthisfieldfromoutside', $field);
        ...
        global $arf_selectbox_loaded,$arfsettings;
        $arf_selectbox_loaded['field_' . $field['field_key']] = 1;
        if( isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' && $_COOKIE['load_footer_scripts'] == base64_encode('load_footer_scripts') ){
            $_COOKIE['arf_selectpicker_loaded'][$field['form_id']] = 1;
        } else {
            unset( $_COOKIE['arf_selectpicker_loaded'] );
        }
        if ($field['size'] != 1) {
    ...
    ?>
    <div class="sltstandard_front controls" <?php
    if (isset($field['field_width']) and $field['field_width'] != '') {
        echo 'style="width:' . $field['field_width'] . 'px;"';
    }
    ?>>
             ...
             if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                ...
                <select disabled="disabled" <?php
                if (isset($field['required']) and $field['required']) {
                    echo 'data-validation-required-message="' . esc_attr($field['blank']) . '"';
                }
                ?> <?php do_action('arffieldinputhtml', $field) ?> <?php
                if ($field['size'] != 1) {
                    if ($newarr['auto_width'] != "1") {
                        if (isset($field['field_width']) and $field['field_width'] != '') {
                            echo 'style="width:' . $field['field_width'] . 'px !important; ' . $inline_css_without_style . '"';
                        ...
                        echo 'style="width:auto; ' . $inline_css_without_style . '"';
                    }
                } else {
                    echo 'style="width:auto; ' . $inline_css_without_style . '"';
                }
                ?> data-size="15"  <?php echo $arfieldhelper->get_onchage_func($field); ?>>	 
                    <?php } else { ?>        
                    <select name="<?php echo $field_name ?>" <?php
                    if (isset($field['required']) and $field['required']) {
                        echo 'data-validation-required-message="' . esc_attr($field['blank']) . '"';
                    }
                    ?> id="field_<?php echo $field['field_key'] ?>" <?php do_action('arffieldinputhtml', $field) ?> <?php
                            if ($field['size'] != 1) {
                                ...
                                echo 'style="width:auto;min-width:100px; ' . $inline_css_without_style . '"';
                            }
                            ?> data-size="15" <?php echo $arfieldhelper->get_onchage_func($field); ?> >
                    ...
                    foreach ($field['options'] as $opt_key => $opt) {
                        ...
                        ?>
                        <?php $arfdefault_selected_val = ($field['separate_value']) ? $field['default_value'] : $field['value']; ?>
                        <option value="<?php echo esc_attr($field_val); ?>" <?php if ($armainhelper->check_selected($arfdefault_selected_val, $field_val)) echo 'selected="selected"'; ?> data-content="<?php echo esc_attr($opt); ?>"><?php //echo $opt ?></option>
        ...
        if ($field['options']) {
            ?><div class="setting_checkbox controls" <?php
            if (isset($field['field_width']) and $field['field_width'] != '') {
                echo 'style="width:' . $field['field_width'] . 'px;padding-top:5px;"';
            } else {
                echo 'style="padding-top:5px;"';
            ...
            ?> ><?php
                if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                    ...
                    if (!isset($atts) or ! isset($atts['label']) or $atts['label']) {
                        ...
                        ?><label for="field_<?php echo $field['id'] ?>-<?php echo $opt_key; ?>"><input type="checkbox" name="<?php echo $field_name ?>[]" id="field_<?php echo $field['id'] ?>-<?php echo $opt_key ?>" value="<?php echo esc_attr($field_val); ?>" <?php echo $checked ?> <?php do_action('arffieldinputhtml', $field) ?> <?php if ($k == 0) { ?><?php
                                if (isset($field['required']) and $field['required']) {
                                    echo 'data-validation-minchecked-minchecked="1" data-validation-minchecked-message="' . esc_attr($field['blank']) . '"';
                                }
                                ?><?php } echo (@$_REQUEST['arfaction'] == 'preview') ? $arfieldhelper->get_onchage_func($field) : ''; ?> style=" <?php echo $inline_css_without_style; ?>" data-change="<?php  echo trim(substr(trim(str_replace('onchange="', '', $arfieldhelper->get_onchage_func($field))), 0, -1));  ?>" /><?php echo $opt ?></label>
                                                                                                        <?php
                                if (@$_REQUEST['arfaction'] != 'preview' and $arfieldhelper->get_onchage_func($field) != '') {
                                    ?>
                                <script type="text/javascript">jQuery(document).ready(function () {
                                        jQuery('#field_<?php echo $field['id'] ?>-<?php echo $opt_key ?>').on('ifChanged', function (event) {<?php echo trim(substr(trim(str_replace('onchange="', '', $arfieldhelper->get_onchage_func($field))), 0, -1)); ?>
                                        });
                                    });</script>
                                <?php
                            }
    ...
    } else if ($field['type'] == 'arfslider' and ! is_admin()) {
        global $arfsettings;
        if(isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' &&  $_COOKIE['load_footer_scripts'] == base64_encode('load_footer_scripts') ){
            $_COOKIE['arf_slider_loaded'][$field['form_id']] = 1;
        } else {
            unset( $_COOKIE['arf_slider_loaded'] );
        }
        ...
        ?>            
    <div class="arf_slider_control controls" <?php
    if (isset($field['field_width']) and $field['field_width'] != '') {
        echo 'style="width:' . $field['field_width'] . 'px;"';
    }
    ?>>
             ...
             if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                 ...
                 if (isset($field['arf_range_selector']) && $field['arf_range_selector'] == '1') {
                     ...
                     $arf_range_minnum = (isset($field['arf_range_minnum']) && !empty($field['arf_range_minnum'])) ? $field['arf_range_minnum'] : '';
                     $arf_range_maxnum = (isset($field['arf_range_maxnum']) && !empty($field['arf_range_maxnum'])) ? $field['arf_range_maxnum'] : '';
                     
                     $slider_value = "[" . $arf_range_minnum . "," . $arf_range_maxnum . "]";
                     $slider_defloat_value = $arf_range_minnum . "," . $arf_range_maxnum;
                 } else {
                     $slider_value = $slider_defloat_value = $field['slider_value'];
                     
                 }
                 ?>

            <input type="text" id="field_<?php echo $field['field_key']; ?>_slide" class="arfslider" data-slider-id="field_<?php echo $field['field_key'] ?>_slider" data-slider-min="<?php echo $field['minnum']; ?>" data-slider-max="<?php echo $field['maxnum']; ?>" data-slider-step="<?php echo $field['slider_step']; ?>" data-slider-value="<?php echo $slider_value; ?>"  data-slider-range-selector="<?php echo $field['arf_range_selector']; ?>"  data-slider-default-value="<?php echo $slider_defloat_value; ?>" autocomplete="off" style="cursor:pointer;" />    
            <input type="hidden" id="field_<?php echo $field['field_key']; ?>" class="arfslider_hidden" autocomplete="off" name="<?php echo $field_name ?>" data-value="<?php echo $field['slider_value']; ?>" data-slider-range-selector="<?php echo $field['arf_range_selector']; ?>" value="<?php echo $field['slider_value']; ?>" <?php
            if (isset($field['required']) and $field['required']) {
                echo 'data-validation-required-message="' . esc_attr($field['blank']) . '"';
            }
            ?> <?php echo $arfieldhelper->get_onchage_func($field); ?> />
                   <?php
    ...
    $arf_font_awesome_loaded = 1;
    ?><div class="arf_colorpicker_control controls" <?php
        if (isset($field['field_width']) and $field['field_width'] != '') {
            echo 'style="width:' . $field['field_width'] . 'px;"';
        }
        ?>><?php
            if (apply_filters('arf_check_for_draw_outside', false, $field)) {
                ...
                if ($field['colorpicker_type'] == 'basic') {
                    global $arfcolorpicker_basic_loaded,$arfsettings;
                    $arfcolorpicker_basic_loaded['field_' . $field['field_key']] = array('form_key' => $form->form_key);
                    $colorpickerclass = "arf_basic_colorpicker";
                    if( isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' && $_COOKIE['load_footer_scripts'] == base64_encode('load_footer_scripts') ){
                        $_COOKIE['arf_basic_colorpicker_loaded'][$field['form_id']] = 1;
                    } else {
                        unset( $_COOKIE['arf_basic_colorpicker_loaded'] );
                    }
                } else {
                    global $arfcolorpicker_loaded,$arfsettings;
                    $arfcolorpicker_loaded['field_' . $field['field_key']] = array('form_key' => $form->form_key);
                    $colorpickerclass = "arf_colorpicker";
                    if( isset($_COOKIE['load_footer_scripts']) &&  $_COOKIE['load_footer_scripts'] != '' && $_COOKIE['load_footer_scripts'] == base64_encode('load_footer_scripts') ){
                        $_COOKIE['arf_colorpicker_loaded'][$field['form_id']] = 1;
                    } else {
                        unset( $_COOKIE['arf_colorpicker_loaded'] );
                    }
                }
                ...
                echo '<div class="arfcolorimg"><i class="arfa arfa-paint-brush"></i></div>';
                ...
                echo '<div><input type="text" id="field_' . $field['field_key'] . '" class="arfhiddencolor" value="' . $defaultcolor . '"';
                if (isset($field['required']) and $field['required']) {
                    echo 'data-validation-required-message="' . esc_attr($field['blank']) . '"';
                } echo $arfieldhelper->get_onchage_func($field);
                echo ' name="' . $field_name . '" autocomplete="off" /></div>';
            }
    ...
    do_action('form_fields', $field, $field_name);
?>