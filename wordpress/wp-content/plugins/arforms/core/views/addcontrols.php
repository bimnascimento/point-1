                        ...
                        <div style="float:left;">
                            ...
                            <ul class="field_type_list" style="float:left;">
                                ...
                                foreach ($arffield_selection as $field_key => $field_type) {
                                    ...
                                    ?>
                                    <li style=" <?php echo $floating_style; ?> margin-bottom: 10px; width: 139px;" class="frmbutton <?php echo $col_class ?> frm_t<?php echo $field_key ?> <?php
                                    if ($i % 2 == 0)
                                        echo 'arffield_odd';
                                    else
                                        echo 'arffield_even';
...
<?php } ?>
                            ...
                            <fieldset class="clearfix">			    
                                ...
                                <div id="tabinputfieldsettings" class="widget clearfix global-font">
                                    ...
                                    <div class="widget-inside" style="visibility:visible;">
                                        ...
                                        <div class="field-group clearfix subfield">
                                            ...
                                            <div class="sltstandard1" style=" <?php echo $calender_theme_opt; ?>">
                                                ...
                                                <dl class="arf_selectbox" data-name="arffths" data-id="arfformsthemesettingselbx" style="width:122px;">
                                                    <dt><span><?php
                                                        if (isset($newarr['arfcalthemename']) && $newarr['arfcalthemename'] != "" && $newarr['arfcalthemename'] != "default_theme" && $newarr['arfcalthemename'] != "default_theme_jquery-ui") {
                                                            echo isset($jquery_classicthemes[$newarr['arfcalthemename']])?$jquery_classicthemes[$newarr['arfcalthemename']]:'';
															echo isset($jquery_solidthemes[$newarr['arfcalthemename']])?$jquery_solidthemes[$newarr['arfcalthemename']]:'';
                                                        } else {
                                        ...
                                        ?>
                                        <div class="clearfix subfield" id="check_radio_main_icon" <?php if ($newarr['arfcheckradiostyle'] == "custom") { ?> style="display:block;margin-top:10px;" <?php
                                        } else {
                                            echo "style='display:none;margin-top:10px;'";
                                        }
                                        ?>>
                                            <label class="lblsubheading sublblheading" style=" <?php echo $check_radio_style_lbl1; ?>"><?php _e('Icon', 'ARForms') ?></label>
                                            <div class="sltstandard1" style="float:left;width: 54%;">
                                                        ...
                                                        <div class="arf_check_radio_container_wrapper" data-action='edit' data-field='checkbox' id="arf_edit_check" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type='checkbox'>
                                                            <div class="arf_check_container" id="arf_select_checkbox">
                                                                ...
                                                                if (isset($newarr['arf_checked_checkbox_icon']) && $newarr['arf_checked_checkbox_icon'] != '') {
                                                                    echo "<i id='arf_prefix_suffix_icon' class='arf_prefix_suffix_icon arfa {$newarr['arf_checked_checkbox_icon']}'></i>";
                                                                } else {
                                                                    _e('No Icon', 'ARForms');
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="arf_check_radio_container_wrapper" data-action='edit' data-field='radio' id="arf_edit_radio" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type='radio'>
                                                            <div class="arf_radio_container" id="arf_select_radio">
                                                                ...
                                                                if (isset($newarr['arf_checked_radio_icon']) && $newarr['arf_checked_radio_icon'] != '') {
                                                                    echo "<i id='arf_prefix_suffix_icon' class='arf_prefix_suffix_icon arfa {$newarr['arf_checked_radio_icon']}'></i>";
                                                                } else {
                                                                    _e('No Icon', 'ARForms');
                                                                }
                                                                ?>
                                                ...
                                                <input type="hidden" name="arf_checkbox_icon" id="arf_checkbox_icon" value="<?php echo isset($newarr['arf_checked_checkbox_icon']) ? $newarr['arf_checked_checkbox_icon'] : '' ?>" />
                                                ...
                                                <input type="hidden" name="arf_radio_icon" id="arf_radio_icon" value="<?php echo isset($newarr['arf_checked_radio_icon']) ? $newarr['arf_checked_radio_icon'] : '' ?>" />
                                            ...
                                            <div class=" <?php echo $check_radio_bg_col_lbl_cls; ?>" style=" <?php echo $check_radio_bg_col_lbl_css; ?>">
                                                ...
                                                <div class="arf_coloroption_sub">
                                                    <div class="arf_coloroption arfhex" data-fid="checked_checkbox_icon_color" style="background:<?php echo isset($newarr['checked_checkbox_icon_color']) ? esc_attr($newarr['checked_checkbox_icon_color']) : '' ?>;"></div>
                                                    <div class="arf_coloroption_subarrow_bg">
                                                        <div class="arf_coloroption_subarrow"></div>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="cbscol" id="checked_checkbox_icon_color" class="txtxbox_widget hex" value="<?php echo isset($newarr['checked_checkbox_icon_color']) ? esc_attr($newarr['checked_checkbox_icon_color']) : '' ?>" style="width:100px;" />
                                            </div>

                                            <div class=" <?php echo $check_radio_bg_col_lbl_cls; ?>" style=" <?php echo $check_radio_bg_col_lbl_css; ?>">

                                                <div class="arf_coloroption_sub">
                                                    <div class="arf_coloroption arfhex" data-fid="checked_radio_icon_color" style="background:<?php echo isset($newarr['checked_radio_icon_color']) ? esc_attr($newarr['checked_radio_icon_color']) : '' ?>;"></div>
                                                    <div class="arf_coloroption_subarrow_bg">
                                                        <div class="arf_coloroption_subarrow"></div>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="rbscol" id="checked_radio_icon_color" class="txtxbox_widget hex" value="<?php echo isset($newarr['checked_radio_icon_color']) ? esc_attr($newarr['checked_radio_icon_color']) : '' ?>" style="width:100px;" />
                                            </div>
                                        </div>
    ...
    <?php
    $reset_modal_width = (@$_COOKIE['width'] - 560) / 2;
    $reset_modal_height = (@$_COOKIE['height'] - 180) / 2;
    ?>

    <div id="reset_global_styling_settings_confirm" style="display:none;left:<?php echo $reset_modal_width . 'px'; ?>; top:<?php echo $reset_modal_height . 'px'; ?>;" class="arfmodal arfhide arffade arfdeletemodabox">
        <div class="arfnewmodalclose" data-dismiss="arfmodal"><img alt='' src="<?php echo ARFIMAGESURL . '/close-button.png'; ?>" align="absmiddle" /></div>
        <div class="arfdelete_modal_title"><img alt='' src="<?php echo ARFIMAGESURL . '/reset-form-icon.png'; ?>" align="absmiddle" style="margin-top:-5px;" />&nbsp;<?php _e('RESET FORM STYLE', 'ARForms'); ?></div>
        <div class="arfdelete_modal_msg"><?php _e('Are you sure you want to reset form style?', 'ARForms'); ?></div>
        <div class="arf_delete_modal_row">
            <div class="arf_delete_modal_left" onclick="reset_global_styling_settings();"><img src="<?php echo ARFIMAGESURL . '/okay-icon.png'; ?>" align="absmiddle" style="margin-right:10px;" />&nbsp;<?php _e('Okay', 'ARForms'); ?></div>
            <div class="arf_delete_modal_right" data-dismiss="arfmodal"><img alt='' src="<?php echo ARFIMAGESURL . '/cancel-btnicon.png'; ?>" align="absmiddle" style="margin-right:10px;" />&nbsp;<?php _e('Cancel', 'ARForms'); ?></div>
        </div>
    </div>
...
if (version_compare($GLOBALS['wp_version'], '3.7', '<')) {
    ...
    wp_register_script('filedrag-js', ARFURL . '/js/filedrag/filedrag_lower.js', array(), $arfversion);
...
<script  type="text/javascript" data-cfasync="false">
    ...
    hoverClass: ' ',
    checkedCheckboxClass: checked_checkbox_class,
    checkedRadioClass: checked_radio_class
    });
    } else {
