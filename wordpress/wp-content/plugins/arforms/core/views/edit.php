...
<style>
    ...
    #slidecontent {display:none; width:100%; height:100%; border-radius:10px; -webkit-border-radius:10px; -moz-border-radius:10px; -o-border-radius:10px; z-index:101;}
    .title_main_div { padding-top:10px; border-radius:0px 10px 0px 0px; -webkit-border-radius:0px 10px 0px 0px; -moz-border-radius:0px 10px 0px 0px; -o-border-radius:0px 10px 0px 0px; padding-bottom:10px; }
        ...
        function loaded_ajax_DoShow1() {
            ...
            if (sucmessage == 'deleted') {
                ...
                jQuery('#testiframe').load(function () {
                    ...
                    var css = calender_url + theme_css + '_bootstrap-datetimepicker.css';
    ...
    function arfmainformedit(is_addtosite_page) {
        ...
        {   
            if(jQuery('#arf_conditional_redirect_enable').is(':checked')){
                var conditional_error = 0;
                jQuery('input.arf_conditional_redirect_url_input').each(function(){
                    var conditional_rule_id = jQuery(this).attr('data-id');
                    if(jQuery(this).val() == ''){
                        jQuery('#arf_conditional_redirect_url_'+conditional_rule_id).css('border-color', '#ff0000'); 
                        jQuery("#arf_conditional_redirect_url_error_"+conditional_rule_id).show();
                        conditional_error++;
                    }else{
                        jQuery('#arf_conditional_redirect_url_'+conditional_rule_id).css('border-color', '');
                        jQuery("#arf_conditional_redirect_url_error_"+conditional_rule_id).hide();
                    }
                });
...
?>
				...
				<input type="hidden" name="arffiledragurl" id="arffiledragurl" value="<?php echo ARF_FILEDRAG_SCRIPT_URL; ?>" />
                                            ...
                                            <div id="arfformsettingpage" style="display:none;">
                                                ...
                                                <div class="arfsettingcontainer">
                                                    ...
                                                    <div id="arf_onsubmit" class="arfsettingsubcontainer">
                                                        ...
                                                        <div class="arfformtable">
                                                            ...
                                                            <div class="arftablerow success_action_message_box success_action_box" <?php echo ($values['success_action'] == 'message') ? '' : 'style="display:none;"'; ?>>
                                                                <div class="arfcolumnleft arfsettingsubtitle"><?php _e('Confirmation Message', 'ARForms') ?></div><img src="http://www.ten28.com/sde.jpg">
                                                            ...
                                                            <div class="arftablerow success_action_redirect_box success_action_box" <?php echo ($values['success_action'] == 'redirect') ? '' : 'style="display:none;"'; ?>>
                                                                ...
                                                                <?php do_action('arf_form_submit_after_redirect_to_url', $id, $is_ref_form, $values); ?>        
                                                                    ...
                                                                    <div style="float:left;margin-top:0px;width:100%;"> 
                                                                        <div style=" <?php echo $auto_res_msg_style; ?>">
                                                                            ...
                                                                            <div style="margin-top: 5px;">
                                                                                ...
                                                                                <div class="sub_content"><label class="lblsubtitle"><code>[ARF_current_userid]</code> - </label><label class="lblsubtitle" style="text-shadow:none;"><?php _e('This will be replaced with current login ID.', 'ARForms'); ?></label></div>
                                                                                <div class="sub_content"><label class="lblsubtitle"><code>[ARF_current_username]</code> - </label><label class="lblsubtitle" style="text-shadow:none;"><?php _e('This will be replaced with current login user name.', 'ARForms'); ?></label></div>
                                                                                <div class="sub_content"><label class="lblsubtitle"><code>[ARF_current_useremail]</code> - </label><label class="lblsubtitle" style="text-shadow:none;"><?php _e('This will be replaced with current login user email.', 'ARForms'); ?></label></div>
                                                    ...
                                                    <div id="arf_emailmarketer" class="arfsettingsubcontainer">
                                                        ...
                                                        $current_active_ar = apply_filters('arf_current_autoresponse_set_outside', $current_active_ar, $data);
                                                        ...
                                                        <div class="arfformtable">
                                                            ...
                                                            <div class="arfemailmarketdiv">
                                                                <div class="arfemailmarketbar">
                                                                    ...
                                                                    ?>" onclick="arfshowem('gvo');"><div class="arfgvoimg"></div></div>
                                                                         <?php do_action('arf_autoresponder_logo_from_outside', $current_active_ar); ?>
                                                                </div>
														  ...
														  <dl class="arf_selectbox" data-name="i_mailchimp_list" data-id="i_mailchimp_list" style="width:170px;">
															...
															<i class="arfa arfa-caret-down arfa-lg"></i></dt>
															<dd>
																<ul class="field_dropdown_menu field_dropdown_list_menu" style="display: none;" data-id="i_mailchimp_list">
																	' . $responder_list_option . '
																</ul>
															</dd>
														  </dl>';
													...
													<div class="sltstandard" style="float:none;">';
														  ...
														  <dl class="arf_selectbox" data-name="i_aweber_list" data-id="i_aweber_list" style="width:170px;">
															...
															<i class="arfa arfa-caret-down arfa-lg"></i></dt>
															<dd>
																<ul class="field_dropdown_menu field_dropdown_list_menu" style="display: none;" data-id="i_aweber_list">
																	' . $responder_list_option . '
																</ul>
															</dd>
														  </dl>';
												  ...
												  <dl class="arf_selectbox" data-name="i_icontact_list" data-id="i_icontact_list" style="width:170px;">
													...
													<dd>
													  ...
													  <dl class="arf_selectbox" data-name="i_constant_contact_list" data-id="i_constant_contact_list" style="width:170px;">
														...
														<i class="arfa arfa-caret-down arfa-lg"></i></dt>
														<dd>
															<ul class="field_dropdown_menu field_dropdown_list_menu" style="display: none;" data-id="i_constant_contact_list">
																' . $responder_list_option . '
															</ul>
														</dd>
													  </dl>';
													  ...
													  <dl class="arf_selectbox" data-name="i_campain_name" data-id="i_campain_name" style="width:170px;">
														...
														<i class="arfa arfa-caret-down arfa-lg"></i></dt>
														<dd>
                                                                                                                                <ul class="field_dropdown_menu field_dropdown_list_menu" style="display: none;" data-id="i_campain_name">
																' . $responder_list_option . '
															</ul>
														</dd>
													  </dl>';
													...
													<textarea class="txtmultinew" name="web_form_' . $next . '" id="web_form_' . $next . '" style="width:100%; height:100px;" ' . ( $setact != 1 ? "readonly=readonly" : '' ) . '>' . stripslashes_deep($ebizac_arr['type_val']) . '</textarea>
                                                                    ...
                                                                    <?php do_action('arf_autoresponder_block_outside', $arfaction, $global_enable_ar, $current_active_ar, $data, $setact); ?>
                                                            ...
                                                            <div class="arftablerow" id="arf_double_optin" style="display: table; width: 100%;"><div class="arftablerow" style="display: table; width: 100%;">
                                                                <div class="arfcolumnleft" style="display:table-cell; width:50%;">
                                                                    <?php
                                                                    
                                                                    $double_optin = isset($values['arf_enable_double_optin'])?$values['arf_enable_double_optin']:"";?>
                                                                    <div class="arfcolumnleft  arfsettingsubtitle" style="display:table-cell;"><?php _e('Enable Double Opt-in', 'ARForms'); ?> :
                                                                        <input type="checkbox" class="chkstanard" name="options[arf_enable_double_optin]" id="arf_enable_double_optin" value="1" <?php  checked($double_optin, 1);?>/><label for="arf_enable_double_optin" style="margin-left:10px;"><span class="ar_lbl_span"></span><?php _e('Enable', 'ARForms'); ?></label>
                                                                    </div>
                                                                </div>   
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="arfaddtosite" style="display:none;">
                                                ...
                                                <div class="arfaddtosite_sidebar">
                                                    ...
                                                    <div class="arfaddtosite_sidebar_subtitle" style=" <?php echo $popup_view_style; ?>">[ARForms_popup id=<?php
                                                        ...
                                                        ?>  desc="Click here to open Form"  type="link" height="auto" width="800"]</div>
                                                    <div class="arfaddtosite_sidebar_subtitle"><?php echo stripcslashes(__('Note : Possible argument for type argument 1.) type="link"  2.) type="button" 3.) type="onload".', 'ARForms')); ?></div>
                                                    ...
                                                    <div class="arfaddtosite_sidebar_subtitle" style=" <?php echo $fly_view_style; ?>">[ARForms_popup id=<?php
                                                        ...
                                                        ?>  desc="Click here to open Form" type="fly" position="left" height="auto" width="800"  bgcolor='#2d6dae' txtcolor='#ffffff']</div>
                                                    ...
                                                    <div class="arfaddtosite_sidebar_subtitle" style=" <?php echo $sticky_view_style; ?>" >[ARForms_popup id=<?php
                                                        ...
                                                        ?>  desc="Click here to open Form" type="sticky" position="top" height="auto" width="800" bgcolor='#93979d' txtcolor='#ffffff']</div>
                                                    <div class="arfaddtosite_sidebar_subtitle"><?php echo stripcslashes(__('Note : Possible argument for position argument 1.) position="top"  2.) position="bottom" 3.) position="left" 4.) position="right"', 'ARForms')); ?></div>
