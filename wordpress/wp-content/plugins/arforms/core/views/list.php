...
<div class="wrap arfforms_page">
	...
	<div id="poststuff" class="metabox-holder">
		...
		<div class="wrap_content">
            ...
            <div class="page_title"><?php _e('Manage Forms', 'ARForms');?></div>
                ...
                <div class="arf_loder_form_section" id="arf_loder_form_list_div">
    ...
    ?>
    <div class="documentation_link" style="background:none; background:none; padding-top:40px;" align="<?php echo $doc_link_align; ?>"><a href="<?php echo ARFURL;?>/documentation/index.html" style="margin-right:10px;" target="_blank"><?php _e('Documentation','ARForms');?></a>|<a href="https://helpdesk.arpluginshop.com/" style="margin-left:10px;" target="_blank"><?php _e('Support','ARForms');?></a> &nbsp;&nbsp;<img src="<?php echo ARFURL;?>/images/dot.png" height="10" width="10" onclick="javascript:OpenInNewTab('<?php echo ARFURL;?>/documentation/assets/sysinfo.php');" /></div>
