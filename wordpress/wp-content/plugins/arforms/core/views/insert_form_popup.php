...
<script>
    ...
    function arfinsertform() {
        ...
        if (form_id == "") {
            alert("<?php _e('Please select a form', 'ARForms') ?>");
            return;
        }
        ...
        if (shrt_type == 'normal')
        {
            ...
            setTimeout(function () {
                ...
                if (link_type == 'sticky') {
                    ...
                    window.send_to_editor(" [ARForms_popup id=" + form_id + " type='" + link_type + "' height='" + modal_height + "' width='" + modal_width + "' on_delay='" + open_delay + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' ]");

                } else if (link_type == 'scroll') {
                    window.send_to_editor(" [ARForms_popup id=" + form_id + " type='" + link_type + "' height='" + modal_height + "' width='" + modal_width + "' on_scroll='" + open_scroll + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' ]");
                } else if (link_type == 'button') {
                    window.send_to_editor(" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' height='" + modal_height + "' width='" + modal_width + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' modal_bgcolor='" + modal_bgcolor + "']");
                } else {
                    window.send_to_editor(" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' height='" + modal_height + "' width='" + modal_width + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "']");
                }
            }, 10);
    ...
    function frm_insert_display() {
        ...
        if (display_id == "") {
            alert("<?php _e('Please select a custom display', 'ARForms') ?>");
            return;
        }
...
jQuery('#arfinsertform').click(function(event){
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('#link_type').change(function () {
            ...
            else if (show_link_type == 'fly')
            {
                ...
                jQuery("#arf_btn_bgcolor .arf_coloroption.arfhex").css('background', '#808080');
                var fid = jQuery('#arf_btn_bgcolor .arf_coloroption.arfhex').attr('data-fid');
            ...
            if (show_link_type == 'onload' || show_link_type == 'scroll') {
                jQuery('#shortcode_caption').slideUp();
                jQuery('#overlay_div').slideDown();
            } else {
...
wp_register_script('arfbootstrap-js', ARFURL . '/bootstrap/js/bootstrap.min.js',array(),$arfversion);
$armainhelper->load_scripts(array('arfbootstrap-js'));

wp_register_script('arfbootstrap-select-js', ARFURL . '/bootstrap/js/bootstrap-select.js',array(),$arfversion);
...
<div id="arfinsertform" style="display:none;"  class="arfmodal hide fade">
   ...
   ?>
    ...
    <div class="newform_modal_fields" style="margin-bottom:30px;">
        ...
        <div class="newmodal_field"><input type="radio" class="rdomodal" checked="checked" name="shortcode_type" value="normal" id="shortcode_type_normal"  /><label for="shortcode_type_normal" <?php
            if (is_rtl()) {
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" class="rdomodal" name="shortcode_type" value="popup" id="shortcode_type_popup" /><label for="shortcode_type_popup" <?php
                                                                                                                        if (is_rtl()) {
        ...
        <div id="show_link_type" style="display:none; margin-top:15px;">   
            ...
            <div class="arfmodalfields" id="normal_link_type"> 	
                ...
                <div class="arfmodalfield_right">
                    ...
                    ?>">
                        <select name="link_type" id="link_type" data-width="272px" onchange="javascript:changetopposition(this.value);">
            ...
            <div class="arfmodalfields" id="is_scroll" style="display:none;"> 	
                <div class="arfmodalfield_left" style="vertical-align: top;"><?php _e('Open popup when user scroll % of page after page load', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <input type="text" name="open_scroll" id="open_scroll" value="10" class="txtmodal1" style="width:70px;" /> %
                    <span style="font-style:italic;">&nbsp;<?php _e('(eg. 100% - end of page)', 'ARForms'); ?></span>
                </div>          
            </div>

            <div class="arfmodalfields" id="is_delay" style="display:none;"> 	
                <div class="arfmodalfield_left"><?php _e('Open popup after page load', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <input type="text" name="open_delay" id="open_delay" value="0" class="txtmodal1" style="width:70px;" />
            ...
            <div class="arfmodalfields" id="overlay_div" > 	
                <div class="arfmodalfield_left" style="padding-top: 10px; vertical-align: top;"><?php _e('Background Overlay :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    ...
                    ?>">
                        <select name="overlay" id="overlay" data-width="90px" data-size="4" >
                        ...
                        <div style="display: inline-block; float:left; margin-left:10px;" class="arf_coloroption_sub">
                            <div data-fid="arf_modal_bg_color" class="arf_coloroption arfhex" style="background: #000000"></div>
            ...
            <div class="arfmodalfields" id="is_close_link_div">
                <div class="arfmodalfield_left" style="vertical-align: top;"><?php _e('Show Close Button :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <input type="radio" class="rdomodal" checked="checked"  name="show_close_link" value="yes" id="show_close_link_yes" />
                    <label for="show_close_link_yes" <?php
                    if (is_rtl()) {
                        echo 'style="float:right; margin-right:167px;"';
                    }
                    ?>>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" class="rdomodal" name="show_close_link" value="no" id="show_close_link_no" />
                    <label for="show_close_link_no" <?php
                    if (is_rtl()) {
                        echo 'style="float:right;"';
                    }
                    ?>>
            ...
            <div class="arfmodalfields" id="arfmodalbuttonstyles" style="display:none;">
                <div class="arfmodalfield_left" style='vertical-align:top;padding-top: 10px;'><?php _e('Colors :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
            ...
            <div class="arfmodalfields"> 	
                <div class="arfmodalfield_left" style="vertical-align: top;padding-top: 10px;"><?php _e('Size :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <div style="display:inline;">
                        <div class="height_setting" style="display: inline;float: left;width: 140px;"><input type="text" onkeyup="if(jQuery(this).val() == 'auto') {jQuery('span#arf_modal_height_px').hide();}else{ jQuery('span#arf_modal_height_px').show();}" class="txtmodal1" name="modal_height" id="modal_height" value="auto" style="width:70px;" />&nbsp;<span class="arf_px" id="arf_modal_height_px" style="display: none;"><?php _e('px', 'ARForms'); ?></span><br/><div style="margin-top: 4px;padding-left: 22px;"><?php _e('Height', 'ARForms'); ?></div></div>
                        <div class="height_setting" style="display: inline-block; float: none;">
                            <input type="text" class="txtmodal1" name="modal_width" id="modal_width" value="800" style="width:70px;" />&nbsp;<span class="arf_px"><?php _e('px', 'ARForms'); ?></span><br/><div style="margin-top: 4px;padding-left: 22px;"><?php _e('Width', 'ARForms'); ?></div>
            ...
            <div class="arfmodalfields" id="button_angle_div" style="display:none;"> 	
                <div class="arfmodalfield_left" style="padding-top: 5px; vertical-align: top;"><?php _e('Button angle :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
