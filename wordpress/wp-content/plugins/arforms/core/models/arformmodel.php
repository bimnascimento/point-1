...
class arformmodel {
    ...
    function update($id, $values, $create_link = false, $is_ref_form = 0) {
        ...
        $new_values['autoresponder_id'] = (isset($_REQUEST['autoresponder_id'])) ? @$_REQUEST['autoresponder_id'] : '';
        ...
        $new_values2['arfcalthemename'] = isset($_REQUEST['arffths'])?$_REQUEST['arffths']:'';
