...
if(isset($use_saved) and $use_saved){
	...
	$success_border_color =  $new_values['arfsucessbordercolorsetting'];
	
	$success_bg_color =  $new_values['arfsucessbgcolorsetting']; 
	
	$success_text_color =  $new_values['arfsucesstextcolorsetting'];
	...
	$arfcheck_style_color = $new_values['arfcheckradiocolor'];
        ...
        $arf_checked_checkbox_icon = $new_values['arf_checked_checkbox_icon'];
        
        $enable_arf_checkbox = $new_values['enable_arf_checkbox'];
        
        $arf_checked_radio_icon = $new_values['arf_checked_radio_icon'];
        
        $enable_arf_radio = $new_values['enable_arf_radio'];
        
        $checked_checkbox_icon_color = $new_values['checked_checkbox_icon_color'];
        
        $checked_radio_icon_color = $new_values['checked_radio_icon_color'];
	...
	$success_bg_color =  $_REQUEST['arfmsbcs']; 

    $success_border_color =  $_REQUEST['arfmsbocs']; 

    $success_text_color = $_REQUEST['arfmstcs']; 
	...
	$arfcheck_style_color = $_REQUEST['arfcksc'];
        ...
        $arf_checked_checkbox_icon = $_REQUEST['arf_checkbox_icon'];
        
        $enable_arf_checkbox = $_REQUEST['enable_arf_checkbox'];        
        
        $arf_checked_radio_icon = $_REQUEST['arf_radio_icon'];
        
        $enable_arf_radio = $_REQUEST['enable_arf_radio'];
        
        $checked_checkbox_icon_color = $_REQUEST['cbscol'];
        
        $checked_radio_icon_color = $_REQUEST['rbscol'];
...
$subset = (isset($arfsettings->arf_css_character_set) && !empty($arfsettings->arf_css_character_set)) ?  "&subset=".implode(',',$arfsettings->arf_css_character_set) : ''; 
...
.ar_main_div_<?php echo $form_id;?> input[type=text], .ar_main_div_<?php echo $form_id;?> input[type=password], .ar_main_div_<?php echo $form_id;?> input[type=email], .ar_main_div_<?php echo $form_id;?> input[type=number], .ar_main_div_<?php echo $form_id;?> input[type=url], .ar_main_div_<?php echo $form_id;?> input[type=tel], .ar_main_div_<?php echo $form_id;?> select, .allfields_style, .allfields_active_style, .allfields_error_style{color:<?php echo $text_color ?> !important;background-color:<?php echo $bg_color ?> !important;border-color:<?php echo $border_color ?> !important;border-width:<?php echo $field_border_width ?> !important;border-style:<?php echo $field_border_style ?>;-moz-border-radius:<?php echo $border_radius ?> !important;-webkit-border-radius:<?php echo $border_radius ?> !important;border-radius:<?php echo $border_radius ?> !important; width:<?php if($field_width_unit == '%'){ echo '100%'; }else{ echo ($field_width == '') ? 'auto' : $field_width; } ?> !important;font-size:<?php echo $field_font_size ?>;padding:<?php echo $arffieldpaddingsetting ?>!important;font-weight:<?php echo $check_weight ?>; <?php echo $check_weight_font_style;?> -webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box; height:<?php echo 'auto';?>;line-height:normal !important; direction:<?php echo $text_direction;?> !important; outline:none;clear:none;box-shadow:inherit; display:inline-block !important; margin: 0 !important; } 


.wp-admin .allfields .smaple-textarea, .ar_main_div_<?php echo $form_id;?> textarea{color:<?php echo $textarea_text_color; ?> !important;background-color:<?php echo $textarea_bg_color; ?> !important;border-color:<?php echo $textarea_border_color; ?> !important;border-width:<?php echo $field_textarea_border_width; ?> !important;border-style:<?php echo $field_textarea_border_style; ?>;-moz-border-radius:<?php echo $border_radius ?> !important;-webkit-border-radius:<?php echo $border_radius ?> !important;border-radius:<?php echo $border_radius ?> !important;width:<?php if($field_width_unit == '%'){ echo '100%'; }else{ echo ($field_textarea_width == '') ? 'auto' : $field_textarea_width; } ?> !important;max-width:100%;font-size:<?php echo $field_textarea_font_size; ?> !important; padding:<?php echo $field_textarea_pad; ?>!important;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box; box-shadow:none; direction:<?php echo $text_direction;?>; outline:none; margin-bottom:0; } 
...
.ar_main_div_<?php echo $form_id;?> .arfmainformfield .arf_htmlfield_control{color:<?php echo $label_color ?>;}
...
.ar_main_div_<?php echo $form_id;?> .bootstrap-select:not([class*="span"]):not([class*="col-"]):not([class*="form-control"]) {
    <?php if($field_width == '' || $field_width == 'auto') { $combo_width = '245px'; } else if($field_width_unit == '%') { $combo_width = '100%'; } else { $combo_width = $field_width; }?>
...
<?php  if ($checked_checkbox_icon_color != '') { ?>
    .ar_main_div_<?php echo $form_id;?> .icheckbox_<?php echo $style_property.'.arfa'?> {
        color: <?php echo $checked_checkbox_icon_color;?>;
    }
<?php }
    if ($checked_radio_icon_color != '') {        
?>
    .ar_main_div_<?php echo $form_id;?> .iradio_<?php echo $style_property.'.arfa'?> {
        color: <?php echo $checked_radio_icon_color;?>;
    }
<?php } ?>   
