...
'arf_enable_double_optin'=>1,
	...
	function forms_dropdown_new( $field_name, $field_value='', $blank=true, $field_id=false, $onchange=false,$multiple = false,$is_import_export=0,$show_id = false ){
...
$array = '';
        ...
        <select name="<?php echo $field_name.$array; ?>" id="<?php echo $field_id ?>" style=" <?php echo $sel_frm_box; ?>" class="frm-dropdown" <?php if ($onchange) echo 'onchange="'.$onchange.'"'; ?> data-width="360px" data-size="10" <?php echo $multiple;?>>
            ...
            <?php foreach($forms as $form){ ?>
                ...
                <option <?php echo $optionheight;?> value="<?php echo $form->id; ?>" <?php selected($field_value, $form->id); ?>><?php echo $show_form_itd. $armainhelper->truncate($form->name, 33); ?></option>
