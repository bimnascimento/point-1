...
class arfieldhelper {
    ...
    function get_default_field_opts($values = false, $field = false) {
        ...
        return array(
            'slide' => 0, 'form_select' => '', 'show_hide' => 'show', 'any_all' => 'any', 'align' => $align,'hide_field' => array(), 'hide_field_cond' => array('=='), 'hide_opt' => array(), 'star' => 0,'post_field' => '', 'custom_field' => '', 'taxonomy' => 'category', 'exclude_cat' => 0, 'ftypes' => array(), 'data_type' => '', 'restrict' => 0, 'start_year' => 2000, 'end_year' => 2020, 'read_only' => 0,'locale' => '', 'attach' => false, 'minnum' => $minnum, 'maxnum' => $maxnum,'step' => $step, 'clock' => 12, 'start_time' => '00:00', 'end_time' => '23:' . $end_minute,'dependent_fields' => 0, 'use_calc' => 0, 'calc' => '', 'duplication' => 1,'dyn_default_value' => '', 'field_width' => '', 'label_width' => $style_settings->width,'text_direction' => $style_settings->text_direction, 'align_radio' => '1', 'custom_width_field' => '0','start_date' => "", 'end_date' => "", 'off_days' => "",'arf_range_minnum' => '10','arf_range_maxnum' => '20',
        );
    }
    ...
    function setup_edit_variables($record) {
        ...
        $values = array('id' => $record->id, 'form_id' => $record->form_id, 'conditional_logic' => maybe_unserialize($record->conditional_logic), 'option_order ' => maybe_unserialize($record->option_order));
    ...
    function posted_field_ids($where) {
        ...
        function get_basic_default_html($type = 'text') {
            ...
            if (apply_filters('arfdisplayfieldhtml', true, $type)) {
                ...
                $for = (in_array($type, array('radio', 'checkbox', 'data', 'like', 'arfslider'))) ? '' : 'for="field_[key]"';
...
[if error]<div class="arf_frm_error" [description_style]>[error]</div>[/if error]
        ...
        function get_default_field_options($type, $field, $limit = false) {
            ...
            $field_options = array(
                'size' => '', 'max' => '', 'label' => '', 'blank' => '','max_rows' => '3',
                ...
                'show_year_month_calendar' => '0', 'show_time_calendar' => '0', 'password_placeholder' => '', 'minlength' => '', 'minlength_message' => __('Invalid minimum characters length', 'ARForms'),
                ...
                'confirm_email_placeholder' => '', 'enable_arf_prefix' => '0', 'arf_prefix_icon' => '', 'enable_arf_suffix' => '0', 'arf_suffix_icon' => '', 'arf_show_min_current_date' => 0, 'arf_show_max_current_date' => 0
            );
...
[if description]<div class="arf_field_description arf_heading_description" [description_style]>[description]</div>[/if description]
                ...
                $default_html = '<div id="arf_field_[id]_container" class="arfformfield control-group arfmainformfield [error_class]" [field_style]><div class="arf_htmlfield_control">[description]</div></div>';
            }
        ...
        $fieldoptions = isset($fielddata->field_options) ? maybe_unserialize( $fielddata->field_options ) : '';
...
//                        $field_val = isset($field_options['separate_value']) ? $field_val['value'] : $opt;
        ...
        function calculate_rule($field, $operator, $value) {
            ...
            $field_options = isset($field['field_options']) ? maybe_unserialize($field['field_options']) : '';
            $field['default_value'] = isset($field['default_value']) ? $field['default_value'] : '';
            $field_options['default_blank'] = isset($field_options['default_blank']) ? $field_options['default_blank'] : '';
        ...
        <?php if ($type != 'field_opt') { ?>
                                ...
                                if (!empty($field_list)) {
                                    ...
                                    foreach ($field_list as $field) {
                                        ...
                                        if ($field->type == "checkbox") {
                                            ...
                                            ?>
                    <div class="modal_field_val" id="arfmodalfieldval_<?php echo $field->ref_field_id; ?>" onclick="javascript:void(0);"><strong><?php
                                                    ...
                                                    if(isset($field->field_options['arf_range_selector']) && $field->field_options['arf_range_selector'] == '1'){
                                                       ...
                                                       ?><div class="modal_field_val" id="arfmodalfieldval_<?php echo $field->ref_field_id; ?>" onclick="arfaddtotalfield(this, '<?php echo $field->ref_field_id; ?>', '')"><?php echo $field_name = $armainhelper->truncate($field->name, 40); ?></div><?php 
                                                    }
                                                } else {
                                                    $field->field_options = maybe_unserialize($field->field_options);
                                                    ?>
                                    ...
                                    function arf_getfields_basic_options_section() {
                                        ...
                                        $fieldsbasicoptionsarr = apply_filters('arfavailablefieldsbasicoptions', array(
                                            'text' => array('isrequired' => 1, 'fieldsize' => 2, 'customwidth' => 3, 'labelname' => 4, 'requiredmsg' => 5, 'minlength_message' => 6, 'placeholdertext' => 7, 'cleartextonfocus' => 8, 'validatedefaultvalue' => 9, 'fielddescription' => 10,  'multicolsetting' => 11, 'arf_prefix' => 12),
                                            'textarea' => array('isrequired' => 1, 'fieldsize' => 2, 'customwidth' => 3, 'labelname' => 4, 'requiredmsg' => 5, 'minlength_message' => 6, 'placeholdertext' => 7, 'cleartextonfocus' => 8, 'validatedefaultvalue' => 9, 'fielddescription' => 10,  'multicolsetting' => 11),
                                            'checkbox' => array('isrequired' => 1, 'requiredmsg' => 2, 'alignment' => 3,  'labelname' => 4, 'fielddescription' => 5, 'multicolsetting' => 6),
                                            'radio' => array('isrequired' => 1, 'requiredmsg' => 2, 'alignment' => 3,  'labelname' => 4, 'fielddescription' => 4, 'multicolsetting' => 6),
                                            'select' => array('isrequired' => 1, 'requiredmsg' => 2, 'customwidth' => 3,  'labelname' => 5, 'fielddescription' => 6,  'multicolsetting' => 7),
                                            'file' => array('isrequired' => 1, 'requiredmsg' => 2, 'customwidth' => 3, 'allowedfiletypes' => 4, 'invalidmessage' => 5, 'attachfiletoemail' => 6, 'uploadbuttonbgcolor' => 7,  'uploadbuttontext' => 8, 'removebuttontext' => 9, 'labelname' => 10, 'fielddescription' => 11, 'multicolsetting' => 12),
                                            ...
                                            'number' => array('isrequired' => 1, 'fieldsize' => 2, 'customwidth' => 3, 'labelname' => 4, 'requiredmsg' => 5, 'minlength_message' => 6, 'placeholdertext' => 7, 'cleartextonfocus' => 8, 'validatedefaultvalue' => 9, 'numberrange' => 10, 'invalidmessage' => 11,  'fielddescription' => 12, 'multicolsetting' => 13, 'arf_prefix' => 14),
                                            ...
                                            'date' => array('isrequired' => 1, 'requiredmsg' => 2, 'customwidth' => 3, 'calendarlocalization' => 4, 'labelname' => 5, 'fielddescription' => 6, 'placeholdertext' => 7, 'cleartextonfocus' => 8, 'multicolsetting' => 9, 'yearrange' => 10,  'arf_prefix' => 11, 'offdays' => 12, 'daterange' => 13, 'calendartimehideshow' => 14,'clocksetting' => 15),
                                            ...
                                            'hidden' => array(),
                                            'password' => array('isrequired' => 1, 'fieldsize' => 2, 'customwidth' => 3, 'labelname' => 4, 'requiredmsg' => 5, 'minlength_message' => 6, 'placeholdertext' => 7, 'cleartextonfocus' => 8, 'password_strength' => 9, 'confirm_password' => 10, 'confirm_password_label' => 11, 'invalid_password' => 12, 'password_placeholder' => 13,  'fielddescription' => 14, 'multicolsetting' => 15, 'arf_prefix' => 16),
											...
											'arfslider' => array('handletype' => 1, 'numberrange' => 2, 'numberofsteps' => 3, 'defaultvalue' => 4, 'labelname' => 5, 'fielddescription' => 6, 'trackbgcolor' => 7, 'handlecolor' => 8, 'multicolsetting' => 9),
                                    ...
                                    function arf_get_field_option_value($field, $option) {
                                        ...
                                        $locales = array(
                                            ...
                                            'lt' => __('Lithuanian', 'ARForms'), 
                                            
                                            'nb' => __('Norwegian', 'ARForms'), 
                                            'pl' => __('Polish', 'ARForms'),
                                        ...
                                        switch ($option) {
                                            case 'arf_range_selector':
                                                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Range Selector', 'ARForms') ?>:</td></tr>
                                                    <tr class="fieldoptions_field_style"><td><label class="lblswitch"><span>NO&nbsp;</span></label><input type="checkbox" onchange="arf_change_range_selector_slider('<?php echo $field['id'] ?>');" class="js-switch" name="field_options[arf_range_selector_<?php echo $field['id'] ?>]"  id="arf_range_selector_<?php echo $field['id'] ?>"  <?php echo (isset($field['arf_range_selector']) and $field['arf_range_selector']) ? 'checked="checked"' : ''; ?> value="1" /><label class="lblswitch"><span>&nbsp;YES</span></label></td></tr>
                                                </table>
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td>
                                                            ...
                                                            <?php if($field['type'] == 'textarea') {    ?>
                                                                    ...
                                                                    <input type="text" style="width:105px; float:left; margin-right:5px;" name="field_options[max_rows_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo esc_attr($field['max_rows']); ?>" size="5" />
                                                                    &nbsp;&nbsp;&nbsp;                                                                    
                                                                    <input type="text" style="width:45px; float:left; margin-right:5px;" name="field_options[max_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo esc_attr($field['max']); ?>" size="5" />
                                                                    &nbsp;&nbsp;&nbsp;
                                                                    <input type="text" style="width:45px; float:left;" name="field_options[minlength_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo $field['minlength']; ?>" style="width:100px;" />
                                                                    <br /> 
                                                                    <div class="howto" style="width:110px; float:left;"><?php echo __('Number of rows', 'ARForms'); ?></div>
                                                                    <div class="howto" style="width:50px; float:left;"><?php echo __('Max', 'ARForms') ?></div> 
                                                                    <div class="howto" style="width:50px; float:left;"><?php echo __('Min', 'ARForms') ?></div> 

                                                                <?php } else {
                                                                    ?>
                                                                    <?php if (in_array($field['type'], array('text', 'number', 'password'))) { ?>                                                                   
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="field_options[frm_clear_field_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                            $field['frm_clear_field_indicator'] = isset($field['frm_clear_field_indicator']) ? $field['frm_clear_field_indicator'] : '';
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td><label class="lblswitch"><span>NO&nbsp;</span></label><input type="checkbox" class="js-switch" name="field_options[frm_default_blank_<?php echo $field['id'] ?>]" id="frm_default_blank_<?php echo $field['id'] ?>"  <?php echo ($field['default_blank']) ? 'checked="checked"' : ''; ?> onchange="arfdefaultblank(<?php echo $field['id'] ?>,<?php echo $field['default_blank']; ?>, 2)" value="1" /><label class="lblswitch"><span>&nbsp;YES</span></label>
                                                            <input type="hidden" name="field_options[frm_default_blank_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                            $field['frm_default_blank_indicator'] = isset($field['frm_default_blank_indicator']) ? $field['frm_default_blank_indicator'] : '';
            ...
            case 'usersepratevalues':
                ?>
                                                <table style="float:left;">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td>
                                            <label class="lblswitch">&nbsp;&nbsp;<span>NO&nbsp;</span></label><input type="checkbox" class="js-switch" name="field_options[separate_value_<?php echo $field['id'] ?>]" id="separate_value_<?php echo $field['id'] ?>"  <?php echo ($field['separate_value']) ? 'checked="checked"' : ''; ?> onchange="arfplaceseparatevalue(<?php echo $field['id'] ?>)" value="1" /><label class="lblswitch"><span>&nbsp;YES</span></label><span style="margin-left:10px;"><img alt='' src="<?php echo ARFIMAGESURL ?>/tooltips-icon.png" alt="?" class="arfhelptip" title="<?php _e('Add a separate value to use for calculations, email routing, saving to the database, and many other uses. The option values are saved while the option labels are shown in the form.', 'ARForms') ?>" align="absmiddle" /></span>
                                                            </span>
                                                    </tr>
                                                </table>
            ...
            case 'allowedfiletypes':
                ...
                if ($mimes) {
                    ?>
                                                    <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                <tr><td class="fieldoptions_label_style"><?php _e('Allowed file types', 'ARForms') ?>:<span style="margin-left:10px;"><img alt='' src="<?php echo ARFIMAGESURL ?>/tooltips-icon.png" alt="?" class="arfhelptip" title="<?php _e('Here \'All Types\' means all the file types supported by your wordpress installation.', 'ARForms') ?>" align="absmiddle" /></span></td></tr>
                ...
                ?>
                                                <table style="float:left; width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style"><td style="float:left; padding-right:10px;"><input type="text" name="field_options[minnum_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo esc_attr($field['minnum']); ?>" size="5" /><br /><span class="howto"><?php echo _e('minimum', 'ARForms') ?></span></td><td style="float:left;"><input type="text" name="field_options[maxnum_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo esc_attr($field['maxnum']); ?>" size="5" /><br /><span class="howto"><?php _e('maximum', 'ARForms') ?></span></td></tr>
                                                                ...
                                                                <?php
                                                                break;
             case 'arf_range_defaultvalue':
                 
                 
                ?>
                                                <table style="float:left; width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Range Default Value', 'ARForms') ?>:</td></tr>
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="float:left; padding-right:10px;">
                                                            <input type="text" name="field_options[arf_range_minnum_<?php echo $field['id'] ?>]" id="arf_range_minnum_<?php echo $field['id'] ?>" class="txtstandardnew" value="<?php echo esc_attr($field['arf_range_minnum']); ?>" size="5" <?php echo (isset($field['arf_range_selector']) && $field['arf_range_selector'] == '1') ? '':'disabled="disabled"'; ?> /><br /><span class="howto"><?php echo _e('minimum', 'ARForms') ?></span>
                                                        </td>
                                                        <td style="float:left;">
                                                            <input type="text" name="field_options[arf_range_maxnum_<?php echo $field['id'] ?>]" id="arf_range_maxnum_<?php echo $field['id'] ?>" class="txtstandardnew" value="<?php echo esc_attr($field['arf_range_maxnum']); ?>" size="5" <?php echo (isset($field['arf_range_selector']) && $field['arf_range_selector'] == '1') ? '':'disabled="disabled"'; ?> /><br /><span class="howto"><?php _e('maximum', 'ARForms') ?></span>
                                                        </td>
                                                    </tr>
            ...
            case 'yearrange':
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style fieldoptions_labelstyle"><td class="lblswitch" style="float:left"><span><?php _e('Start Year', 'ARForms') ?>:&nbsp;</span><input type="text" name="field_options[start_year_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo isset($field['start_year']) ? $field['start_year'] : ''; ?>" size="4"/></td><td class="lblswitch" style="float:left; padding-top:6px;"><span style="padding-right:6px;"><?php _e('End Year', 'ARForms') ?>:&nbsp;</span><input type="text" name="field_options[end_year_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo isset($field['end_year']) ? $field['end_year'] : ''; ?>" size="4"/></td></tr>
                                                </table>
                                                                    <?php
                                                                    break;
                                                                ...
                                                                case 'clocksetting':
                                                                    ?>
                                                <table id="arf_time_settings_<?php echo $field['id']; ?>" style="float:left;<?php if(($field['type']=='date'&&$field['show_time_calendar']==1)||$field['type']=='time'){echo 'display:block;';}else{echo 'display:none;';}?>" border="0" cellpadding="0" cellspacing="0">	
            ...
            case 'htmlcontent':
                ...
                ?>">
                                                                    ...
                                                                    <div style=" position:relative;right:0;left:115px;top:-31px;" class="main_field_modal ">
            ...
            case 'likebtntitle':
                ?>
                                                ...
                                                <table style="float:left;">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="float:left">
                                        <div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[lbllike_<?php echo $field['id'] ?>]" value="<?php echo esc_attr($like_label); ?>"  style="width:180px;" /></div>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            case 'dislikebtntitle':
                ?>
                                                ...
                                                <table style="float:left;" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="float:left">
                                        <input type="text" class="txtstandardnew" name="field_options[lbldislike_<?php echo $field['id'] ?>]" value="<?php echo esc_attr($dislike_label); ?>"  style="width:160px;" />		
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="float:left;" cellpadding="0" cellspacing="0" border="0">	
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="width:60px; font-size:14px; float:left;">
                                                            ...
                                                            <input type="hidden" name="field_options[like_bg_color_<?php echo $field['id'] ?>]" id="like_bg_color_<?php echo $field['id'] ?>" class="txtstandardnew hex" value="<?php echo esc_attr($like_bg_color); ?>" style="width:80px;" size="5" /><span class="howto" style="padding-left:0px;float:left; margin-top: 2px;"><?php _e('Like', 'ARForms') ?></span>
                                                        ...
                                                        <td style="float:left; width:92px; font-size:14px; margin-left:15px;">
                                                            ...
                                                            <input type="hidden" name="field_options[dislike_bg_color_<?php echo $field['id'] ?>]" id="dislike_bg_color_<?php echo $field['id'] ?>" class="txtstandardnew hex" value="<?php echo esc_attr($dislike_bg_color); ?>" style="width:80px;" size="5" /><div class="howto" style="padding-right:10px; margin-top:2px;"><?php _e('Dislike', 'ARForms') ?></div>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            case 'defaultvalue':
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" id="arf_slider_default_value_<?php echo $field['id']; ?>" name="field_options[slider_value_<?php echo $field['id']; ?>]" value="<?php echo $field['slider_value']; ?>"  <?php echo (isset($field['arf_range_selector']) && $field['arf_range_selector'] == '1') ? 'disabled="disabled"':''; ?>  style="width:180px;" /></div>
                                                        </td>
                                                    </tr>
            ...
            case 'trackbgcolor':
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Track BG color', 'ARForms') ?>:</td></tr>
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="width:90px; font-size:14px; float:left;">
                                                            ...
                                                            <input type="hidden" name="field_options[slider_bg_color_<?php echo $field['id'] ?>]" id="slider_bg_color_<?php echo $field['id'] ?>" class="txtstandardnew hex" value="<?php echo esc_attr($slider_left_bg_color); ?>" style="width:80px;" size="5" /><span class="howto" style="padding-left:0px;float:left; margin-top: 2px;"><?php _e('Left side', 'ARForms') ?></span></td>
                                                        ...
                                                        <td style="float:left; width:92px; font-size:14px; margin-left:15px;">
                                                            ...
                                                            <input type="hidden" name="field_options[slider_bg_color2_<?php echo $field['id'] ?>]" id="slider_bg_color2_<?php echo $field['id'] ?>" class="txtstandardnew hex" value="<?php echo esc_attr($slider_right_bg_color); ?>" style="width:80px;" size="5" /><div class="howto" style="padding-right:10px; margin-top:2px;"><?php _e('Right side', 'ARForms') ?></div>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            case 'placeholdertext':
                ...
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[placeholdertext_<?php echo $field['id']; ?>]" id="placeholdertext_<?php echo $field['id']; ?>" onkeyup="arfchangeplaceholder('<?php echo $field['id']; ?>');" value="<?php echo esc_attr($field['default_value']); ?>"  style="width:185px;" /></div>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            case 'fielddescription':
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[description_<?php echo $field['id']; ?>]" id="description_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['description']); ?>" style="width:185px;" /></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[name_<?php echo $field['id']; ?>]" id="arfname_<?php echo $field['id']; ?>" onkeyup="arfchangelabelname('<?php echo $field['id']; ?>');" value="<?php echo esc_attr($field['name']); ?>" style="width:185px;" /></div>
                                                        </td>
                                                    </tr>
                                                </table>
                ...
                if ($field['phone_validation'] == 'custom_validation_1') {
                    ...
                    $selected_phone_number = "123-456-7890";
                                                                    ...
                                                                    $selected_phone_number = "01234 123 456";
                                                                } else if ($field['phone_validation'] == 'custom_validation_9') {
                                                                    $selected_phone_number = "01234 123456";
                } else {
                ...
                ?>
                                                                ...
                                                                <dl class="arf_selectbox" data-name="field_options[phone_validation_<?php echo $field['id']; ?>]" data-id="phone_validation_<?php echo $field['id']; ?>" style="width:165px;">
                                                                    <dt><span><?php echo $selected_phone_number; ?></span>
                ...
                ?>
                                            ...
                                            case 'confirm_password_label':
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[confirm_password_label_<?php echo $field['id']; ?>]" id="confirm_password_label_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['confirm_password_label']); ?>" style="width:210px;" <?php
                                            ...
                                            case 'confirm_email':
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[confirm_email_label_<?php echo $field['id']; ?>]" id="confirm_email_label_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['confirm_email_label']); ?>" style="width:210px;" <?php
            ...
            case 'invalid_confirm_email':
                ...
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                            <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[invalid_confirm_email_<?php echo $field['id']; ?>]" id="invalid_confirm_email_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['invalid_confirm_email']); ?>" style="width:210px;" <?php
                if (!isset($field['confirm_email']) or ! $field['confirm_email']) {
                    echo 'disabled="disabled"';
                }
                ?> /></div>
            ...
            case 'confirm_email_placeholder':
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[confirm_email_placeholder_<?php echo $field['id']; ?>]" id="confirm_email_placeholder_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['confirm_email_placeholder']); ?>" style="width:185px;" <?php
                                                if (!isset($field['confirm_email']) or ! $field['confirm_email']) {
                                                    echo 'disabled="disabled"';
                                                }
                ?> /></div>
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                    <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[invalid_password_<?php echo $field['id']; ?>]" id="invalid_password_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['invalid_password']); ?>" style="width:210px;" <?php
                                                            if (!isset($field['confirm_password']) or ! $field['confirm_password']) {
                                                                echo 'disabled="disabled"';
                                                            }
                                                            ?> /></div>
            ...
            case 'image_height':
                ?>
                                                ...
                                                <table style="float:left;">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="field_options[frm_show_year_month_calendar_field_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                            $field['show_year_month_calendar'] = isset($field['show_year_month_calendar']) ? $field['show_year_month_calendar'] : '';
                                            ...
                                            case 'calendartimehideshow':
                                                ?>
                                                <table style="float:left;">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Show Time picker', 'ARForms') ?></td></tr>
                                                    <tr class="fieldoptions_field_style">
                                                        <td>
                                                            <label class="lblswitch"><span>NO&nbsp;</span></label><input type="checkbox" class="js-switch" name="field_options[show_time_calendar_<?php echo $field['id'] ?>]" id="frm_show_time_calendar_field_<?php echo $field['id'] ?>"  <?php echo ($field['show_time_calendar']) ? 'checked="checked"' : ''; ?> value="1" onchange="arf_hide_show_time_picker_option(<?php echo $field['id']; ?>);"/><label class="lblswitch"><span>&nbsp;YES</span></label>
                                                            <input type="hidden" name="field_options[frm_show_time_calendar_field_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                            $field['show_time_calendar'] = isset($field['show_time_calendar']) ? $field['show_time_calendar'] : '';
                                                            echo esc_attr($field['show_time_calendar']);
                                                            ?>" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            case 'password_placeholder':
                                                ...
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style">
                                                        <td style="float:left"><div style="float:left;"><input type="text" class="txtstandardnew" name="field_options[password_placeholder_<?php echo $field['id']; ?>]" id="password_placeholder_<?php echo $field['id']; ?>" value="<?php echo esc_attr($field['password_placeholder']); ?>" style="width:185px;" <?php
                                if (!isset($field['confirm_password']) or ! $field['confirm_password']) {
                                    echo 'disabled="disabled"';
                                }
                                ?> /></div>
            ...
            case 'minlength_message':
                ...
                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr class="fieldoptions_field_style"><td><input type="text" name="field_options[minlength_message_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo esc_attr($field['minlength_message']); ?>" style="width:210px;" /></td></tr>
                                                </table>
                ...
                if ($field['arf_prefix_icon'] != '') {
                    echo "<i id='arf_prefix_suffix_icon' class='arf_prefix_suffix_icon arfa {$field['arf_prefix_icon']}'></i>";
                } else {
                    _e('No Icon', 'ARForms');
                }
                ?>
                                                ...
                                                if ($field['arf_suffix_icon'] != '') {
                                                    echo "<i id='arf_prefix_suffix_icon' class='arf_prefix_suffix_icon arfa {$field['arf_suffix_icon']}'></i>";
                                                } else {
                                                    _e('No Icon', 'ARForms');
                                                }
                                                ?>
                                            ...
                                            case 'daterange':
                                                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Date Range', 'ARForms') ?>:</td></tr>
                                                    <tr class="fieldoptions_field_style fieldoptions_labelstyle">
                                                        <td class="lblswitch" style="float:left">
                                                            <input style="width: 185px;" type="text" id="arf_start_date_<?php echo $field['id'] ?>" name="field_options[start_date_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo isset($field['start_date']) ? $field['start_date'] : ''; ?>" size="4" <?php if ($field['arf_show_min_current_date']) { ?> disabled="disabled" <?php } ?>/>
                                                            <div class="arf_current_date_hide_show">
                                        <label class="lblswitch"><span class="arf_current_date_hide_show_label"><?php _e('Set Current Date','ARForms'); ?>:&nbsp;</span><span><?php _e('NO','ARForms'); ?>&nbsp;</span></label><input type="checkbox" class="js-switch" name="field_options[arf_show_min_current_date_<?php echo $field['id'] ?>]" id="frm_arf_show_min_current_date_field_<?php echo $field['id'] ?>"  <?php echo ($field['arf_show_min_current_date']) ? 'checked="checked"' : ''; ?> onchange="arfmincurrentdatefieldfunction(<?php echo $field['id'] ?>, '<?php echo ($field['arf_show_min_current_date'] != '') ? $field['arf_show_min_current_date'] : '0'; ?>', '2')" value="1" /><label class="lblswitch"><span>&nbsp;<?php _e('YES','ARForms'); ?></span></label>
                                                                <input type="hidden" name="field_options[frm_arf_show_min_current_date_field_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                                $field['arf_show_min_current_date'] = isset($field['arf_show_min_current_date']) ? $field['arf_show_min_current_date'] : '';
                                                                echo esc_attr($field['arf_show_min_current_date']);
                                                                ?>" />
                                                            </div>
                                                        </td>
                                                        <td class="lblswitch" style="float:left; padding-left:6px;">
                                                            <input style="width: 185px; margin-left: 25px;" type="text" id="arf_end_date_<?php echo $field['id'] ?>" name="field_options[end_date_<?php echo $field['id'] ?>]" class="txtstandardnew" value="<?php echo isset($field['end_date']) ? $field['end_date'] : ''; ?>" size="4" <?php if ($field['arf_show_max_current_date']) { ?> disabled="disabled" <?php } ?>/>
                                                            <div class="arf_current_date_hide_show arf_current_end_date_hide_show">
                                        <label class="lblswitch"><span class="arf_current_date_hide_show_label"><?php _e('Set Current Date','ARForms'); ?>:&nbsp;</span><span><?php _e('NO','ARForms'); ?>&nbsp;</span></label><input type="checkbox" class="js-switch" name="field_options[arf_show_max_current_date_<?php echo $field['id'] ?>]" id="frm_arf_show_max_current_date_field_<?php echo $field['id'] ?>"  <?php echo ($field['arf_show_max_current_date']) ? 'checked="checked"' : ''; ?> onchange="arfmaxcurrentdatefieldfunction(<?php echo $field['id'] ?>, '<?php echo ($field['arf_show_max_current_date'] != '') ? $field['arf_show_max_current_date'] : '0'; ?>', '2')" value="1" /><label class="lblswitch"><span>&nbsp;<?php _e('YES','ARForms'); ?></span></label>
                                                                <input type="hidden" name="field_options[frm_arf_show_max_current_date_field_indicator_<?php echo $field['id'] ?>]" value="<?php
                                                                $field['arf_show_max_current_date'] = isset($field['arf_show_max_current_date']) ? $field['arf_show_max_current_date'] : '';
                                                                echo esc_attr($field['arf_show_max_current_date']);
                                                                ?>" />
                                                            </div>
                                                        </td>
                                                        <td style="float: left; width: 100%;">
                                                            <div class="howto" style="width:49%; float:left;">
                                                                <?php _e('Min Date e.g. 20/01/2000', 'ARForms'); ?>
                                                            </div>
                                                            <div class="howto" style="width:49%; float:left;">
                                                                <?php _e('Max Date e.g. 20/01/2020', 'ARForms'); ?>
                                                            </div> 
                                                        </td>
                                                    </tr>                                                        
                                                </table>
                                            ...
                                            case 'offdays':
                                                ?>
                                                <table style="float:left;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr class="fieldoptions_label_style"><td><?php _e('Off Days', 'ARForms') ?>:</td></tr>
                                                    <tr class=" fieldoptions_labelstyle">
                                                        <td class="arf_date_days_val_wrapper">
                                                            <?php
                                                            $off_days_val = isset($field['off_days']) ? $field['off_days'] : '';
                                                            $off_days_val_data = array();
                                                            if ($off_days_val != "") {
                                                                $off_days_val_data = explode(",", $off_days_val);
                                                            }
                                                            ?>
                                                            <input type="hidden" name="field_options[off_days_<?php echo $field['id'] ?>]" class="txtstandardnew arf_date_days_val" style="width:185px;" value="<?php echo $off_days_val; ?>" size="4"/>
                                                            <div class="arf_date_days_btn <?php
                                                            if (in_array('0', $off_days_val_data)) {
                                                                echo "arf_select";
                                                            }
                                                            ?>" day_val="0"><?php _e('Sunday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                            if (in_array('1', $off_days_val_data)) {
                                                echo "arf_select";
                                            }
                                                            ?>" day_val="1"><?php _e('Monday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                                                 if (in_array('2', $off_days_val_data)) {
                                                                     echo "arf_select";
                                                                 }
                                                                 ?>" day_val="2"><?php _e('Tuesday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                                            if (in_array('3', $off_days_val_data)) {
                                                                echo "arf_select";
                                                            }
                                                            ?>" day_val="3"><?php _e('Wednesday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                                 if (in_array('4', $off_days_val_data)) {
                                                     echo "arf_select";
                                                 }
                                                 ?>" day_val="4"><?php _e('Thursday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                                 if (in_array('5', $off_days_val_data)) {
                                                     echo "arf_select";
                                                 }
                                                            ?>" day_val="5"><?php _e('Friday', 'ARForms') ?></div>
                                                            <div class="arf_date_days_btn <?php
                                                if (in_array('6', $off_days_val_data)) {
                                                    echo "arf_select";
                                                }
                                                ?>" day_val="6"><?php _e('Saturday', 'ARForms') ?></div>
