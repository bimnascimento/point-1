...
<div class="wrap">
  ...
  <?php
    if ( isset( $_GET['message'] ) ) {
        ...
        switch ( $_GET['message'] ) {
            case 'trashed':
                $message = __( 'Requests deleted!', 'dokan-verification' );
                break;

            case 'cancelled':
                $message = __( 'Requests cancelled!', 'dokan-verification' );
                break;

            case 'approved':
                $message = __( 'Requests approved!', 'dokan-verification' );
                break;
        }
...
<!--                        <input type="checkbox" class="dokan-withdraw-allcheck">-->
                    ...
                    <th width="30%"><?php _e( 'Store Name', 'dokan-verification' ); ?></th>
                    <th width="30%"><?php _e( 'Photo ID', 'dokan-verification' ); ?></th>
                    <th><?php _e( 'Address', 'dokan-verification' ); ?></th>                        
                </tr>
            </thead>
            <tfoot>
                <tr>
...
<!--                        <input type="checkbox" class="dokan-withdraw-allcheck">-->
                    ...
                    <th><?php _e( 'Store Name', 'dokan-verification' ); ?></th>
                    <th><?php _e( 'Photo ID ', 'dokan-verification' ); ?></th>
                    <th><?php _e( 'Address ', 'dokan-verification' ); ?></th>       
...
<!--                            <input type="checkbox" name="id[<?php echo $val['seller_id']; ?>]" value="<?php echo $val['seller_id']; ?>">-->
                        ...
                        <form method="post" action="" class="dokan-admin-sv-action">
                            ...
                            <div class="id_type_wrapper">
                                ...
                                <span class="id_type">
                                        <?php
                                        //echo _e( 'Type : ', 'dokan-verification' );
                            ...
                            <p></p>
                             ...
                             <div class="row-actions">
                                <?php if ( $status == 'pending' ) { ?>
                                    ...
                                    <span class="edit"><a href="#" class="dokan-sv-action" data-type="id" data-status="approved" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Approve', 'dokan-verification' ); ?></a> | </span>
                                    <span class="edit"><a href="#" class="dokan-sv-action" data-type="id" data-status="rejected" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Reject', 'dokan-verification' ); ?></a></span>

                                <?php } elseif ( $status == 'approved' ) { ?>

                                    <span class="trash"><a href="#" class="dokan-sv-action" data-type="id" data-status="disapproved" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Disapprove', 'dokan-verification' ); ?></a> | </span>
<!--                                    <span class="edit"><a href="#" class="dokan-sv-action" data-type="id" data-status="pending" data-seller_id = "<?php //echo $val['seller_id']; ?>"><?php //_e( 'Pending', 'dokan-verification' ); ?></a></span>-->
                            ...
                            <form method="post" action="" class="dokan-admin-sv-action">
                                ...
                                <div class="row-actions">
                                    <?php if ( $status == 'pending' ) { ?>
                                        ...
                                        <span class="edit"><a href="#" class="dokan-sv-action" data-type="address" data-status="approved" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Approve', 'dokan-verification' ); ?></a> | </span>
                                        <span class="trash"><a href="#" class="dokan-sv-action" data-type="address" data-status="rejected" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Reject', 'dokan-verification' ); ?></a></span>

                                    <?php } elseif ( $status == 'approved' ) { ?>

                                        <span class="trash"><a href="#" class="dokan-sv-action" data-type="address" data-status="disapproved" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Disapprove', 'dokan-verification' ); ?></a> | </span>
    
                                    <?php } elseif ( $status == 'rejected' ) { ?>

                                        <span class="edit"><a href="#" class="dokan-sv-action" data-type="address" data-status="approved" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Approve', 'dokan-verification' ); ?></a> | </span>
                                        <span class="edit"><a href="#" class="dokan-sv-action" data-type="address" data-status="pending" data-seller_id = "<?php echo $val['seller_id']; ?>"><?php _e( 'Pending', 'dokan-verification' ); ?></a></span>
                ...
                <tr>
                    <td colspan="8">
                        <?php _e( 'No result found', 'dokan-verification' ) ?>
                    </td>
                </tr>
                <?php
            }
