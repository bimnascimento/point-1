    ...
    <div class="dokan-dashboard-content dokan-verification-content">
        <header class="dokan-dashboard-header">
            <h1 class="entry-title">
                <?php _e( 'Verification', 'dokan-verification' ); ?>
        ...
        <div class="dokan-panel dokan-panel-default dokan_v_id" id="dokan_v_id">
            <div class="dokan-panel-heading">
                <strong><?php _e( 'ID Verification', 'dokan-verification' ); ?></strong>
            </div>
            ...
            <div class="dokan-panel-body">
                ...
                if ( $id_status != '' ) {
                    ...
                    <div class="dokan-alert <?php echo $alert_class ?>" id="dokan_v_id_feedback">
                        <?php echo sprintf( __( 'Your ID verification request is %s', 'dokan-verification' ), $id_status ); ?>
                    </div>
                <?php } ?>
                            ...
                            <div class="dokan-form-group dokan-verify-photo-id">
                                <div class="dokan-w5 dokan-gravatar">
                                    ...
                                    <div class="gravatar-button-area<?php echo $gravatar ? ' dokan-hide' : ''; ?>">
                                        <a href="#" class="dokan-gravatar-drag dokan-btn dokan-btn-default"><i class="fa fa-cloud-upload"></i> <?php _e( 'Upload Photo', 'dokan-verification' ); ?></a>
                                    </div>

                                    <?php wp_nonce_field( 'dokan_verify_action', 'dokan_verify_action_nonce' ); ?>
                                    <input type="submit" id='dokan_v_id_submit' class="dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Submit', 'dokan-verification' ); ?>">
                                    <input type="button" id='dokan_v_id_cancel_form' class="dokan-btn dokan-btn-theme dokan-v-cancel-btn" value="<?php esc_attr_e( 'Cancel', 'dokan-verification' ); ?>">
                ...
                ?>
                <button class="dokan-btn dokan-btn-theme <?php echo esc_attr($cancel_btn_class); ?>" id="dokan_v_id_cancel"><?php _e( 'Cancel Request', 'dokan-verification' ); ?></button>
            </div>
        </div>
        <?php
        ...
        ?>
            <div class="dokan-panel dokan-panel-default dokan_v_phone">
                <div class="dokan-panel-heading">
                    <strong><?php _e( 'Phone Verification', 'dokan-verification' ); ?></strong>
                </div>
                    ...
                    <?php if ( $phone_status != 'verified' ) { ?>
                        ...
                        <div class="dokan_v_phone_box">
                            <form method="post" id="dokan-verify-phone-form"  action="" class="dokan-form-horizontal">
                                ...
                                <div class="dokan-form-group">
                                    <label class="dokan-w3 dokan-control-label" for="phone"><?php _e( 'Phone No', 'dokan-verification' ); ?></label>
                                    <div class="dokan-w5">
                                ...
                                <div class="dokan-form-group">
                                     <input type="submit" id='dokan_v_phone_submit' class="dokan-left dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Submit', 'dokan-verification' ); ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="dokan_v_phone_code_box dokan-hide">
                            <form method="post" id="dokan-v-phone-code-form"  action="" class="dokan-form-horizontal">
                                ...
                                <div class="dokan-form-group">
                                    <label class="dokan-w3 dokan-control-label" for="sms_code"><?php _e( 'SMS code', 'dokan-verification' ); ?></label>
                                    <div class="dokan-w5">
                                ...
                                <div class="dokan-form-group">
                                    <input type="submit" id='dokan_v_code_submit' class="dokan-left dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Submit', 'dokan-verification' ); ?>">
                                </div>
                            </form>
                        </div>
        ...
        <div class="dokan-panel dokan-panel-default">
            <div class="dokan-panel-heading">
                <strong><?php _e( 'Address Verification', 'dokan-verification' ); ?></strong>
            </div>
            ...
            <div class="dokan-panel-body">
                ...
                <div class="dokan-alert <?php echo $alert_class ?>" id="d_v_address_feedback">
                    <?php echo sprintf( __( 'Your Address verification request is %s', 'dokan-verification' ), $address_status ); ?>
                </div>
                ...
                ?>
                <?php
                $btn_name = __( 'Start Verification', 'dokan-verification' );
                if ( $address_status == 'approved' ) {

                    $btn_name = __( 'Change Address', 'dokan-verification' );
                    $addrs_btn_class = '';
                ...
                <button class="dokan-btn dokan-btn-theme dokan-v-start-btn <?php echo esc_attr($addrs_btn_class); ?>" id="dokan_v_address_click"><?php echo $btn_name; ?></button>
                    ...
                    <div class="dokan_v_address_box dokan-hide">
                        <form method="post" id="dokan-verify-address-form"  action="" class="dokan-form-horizontal">
                            ...
                            <div class="dokan-form-group">
                                <input type="submit" id='dokan_v_address_submit' class="dokan-left dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Submit', 'dokan-verification' ); ?>">
                                <input type="button" id='dokan_v_address_cancel' class="dokan-left dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'Cancel', 'dokan-verification' ); ?>">
                ...
                ?>
                <button class="dokan-btn dokan-btn-theme <?php echo esc_attr($cancel_btn_class); ?>" id="dokan_v_address_cancel"><?php _e( 'Cancel Request', 'dokan-verification' ); ?></button>
        ...
        <div class="dokan-panel dokan-panel-default">
            <div class="dokan-panel-heading clickable">
                <strong><?php _e( 'Social Profiles', 'dokan-verification' ); ?></strong>
            </div>
                ...
                <div class="dokan-verify-links">
                                        ...
                                        <div class="dokan_verify_dc_button">
                                            <a href="<?php echo add_query_arg( array( 'dokan_auth_dc' => $provider ), dokan_get_navigation_url( 'settings/verification' ) ); ?>">
                                                <button class="dokan-btn dokan-btn-block"><?php
                                                    _e( 'Disconnect ', 'dokan-verification' );
                                                    echo ucwords( $provider );
                                                    ?>
                                                </button>
                                            </a>
                    ...
                    <?php } else { ?>
                        <div class="dokan-alert dokan-alert-info">
                                <?php echo __( 'No Social App is configured by website Admin', 'dokan-verification' ) ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
